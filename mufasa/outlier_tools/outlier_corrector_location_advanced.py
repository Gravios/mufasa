...
class OutlierCorrecterLocationAdvanced(ConfigReader, FeatureExtractionMixin):
    ...
    .. note::
       See `notebook <https://mufasa-uw-tf-dev.readthedocs.io/en/latest/nb/advanced_outlier_correction.html>`__. for example use-case.
    ...
    >>> outlier_corrector = OutlierCorrecterLocationAdvanced(config_path='/path/to/troubleshooting/two_black_animals_14bp/project.toml', input_dir='/path/to/troubleshooting/two_black_animals_14bp/project_folder/csv/input_csv', type='animal', agg_method='mean', criterion_body_parts=criterion_body_parts, settings=settings)
    ...
    >>> outlier_corrector = OutlierCorrecterLocationAdvanced(config_path='/path/to/troubleshooting/two_black_animals_14bp/project.toml', input_dir='/path/to/troubleshooting/two_black_animals_14bp/project_folder/csv/input_csv', type='body-part', agg_method='mean', criterion_body_parts=criterion_body_parts, settings=settings)
    """

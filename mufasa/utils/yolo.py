...
def fit_yolo(weights_path: Union[str, os.PathLike],
    ...
    .. note::
       ...
       `Example model_yaml <https://github.com/sgoldenlab/mufasa/blob/master/misc/ex_yolo_model.yaml>`__.

    .. seealso::
       For the recommended wrapper class with parameter validation, see :class:`mufasa.model.yolo_fit.FitYolo`.
    ...
    :param model_yaml: YAML file containing paths to the training, validation, and testing datasets and the object class mappings. Example YAML file can be found [here](https://github.com/sgoldenlab/mufasa/blob/master/misc/ex_yolo_model.yaml).
...
def load_yolo_model(weights_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For recommended wrapper classes that use this function, see :class:`mufasa.model.yolo_fit.FitYolo`, :class:`mufasa.model.yolo_inference.YoloInference`, :class:`mufasa.model.yolo_pose_inference.YOLOPoseInference`, :class:`mufasa.model.yolo_seg_inference.YOLOSegmentationInference`, and :class:`mufasa.model.yolo_pose_track_inference.YOLOPoseTrackInference`.
...
def yolo_predict(model: YOLO,
    ...
    .. seealso::
       For recommended wrapper classes that use this function, see :class:`mufasa.model.yolo_inference.YoloInference`, :class:`mufasa.model.yolo_pose_inference.YOLOPoseInference`, and :class:`mufasa.model.yolo_seg_inference.YOLOSegmentationInference`.

    :param Union[str, os.PathLike] model: Loaded ultralytics.YOLO model. Returned by :func:`~mufasa.bounding_box_tools.yolo.model.load_yolo_model`.

...
def blob_tracker(config_path: Union[str, os.PathLike]) -> None:
    ...
    .. note::
       For an example blob detection config file, see `https://github.com/sgoldenlab/mufasa/blob/master/misc/blob_definitions_ex.json <https://github.com/sgoldenlab/mufasa/blob/master/misc/blob_definitions_ex.json>`__.

...
from mufasa.model.grid_search_rf import GridSearchRandomForestClassifier
from mufasa.model.inference_validation import InferenceValidation
...
from mufasa.plotting.interactive_probability_grapher import \
    InteractiveProbabilityGrapher
from mufasa.third_party_label_appenders.BENTO_appender import BentoAppender
from mufasa.third_party_label_appenders.BORIS_appender import BorisAppender
from mufasa.third_party_label_appenders.deepethogram_importer import \
    DeepEthogramImporter
from mufasa.third_party_label_appenders.ethovision_import import \
    ImportEthovision
...
from mufasa.ui.pop_ups.annotated_bouts_videos_pop_up import \
    AnnotatedBoutsVideoPopUp
from mufasa.ui.pop_ups.append_roi_features_animals_pop_up import \
...
from mufasa.ui.pop_ups.clf_annotation_counts_pop_up import \
    ClfAnnotationCountPopUp
from mufasa.ui.pop_ups.clf_by_roi_pop_up import ClfByROIPopUp
from mufasa.ui.pop_ups.clf_by_timebins_pop_up import TimeBinsClfPopUp
from mufasa.ui.pop_ups.clf_descriptive_statistics_pop_up import \
    ClfDescriptiveStatsPopUp
from mufasa.ui.pop_ups.clf_plot_pop_up import SklearnVisualizationPopUp
from mufasa.ui.pop_ups.clf_probability_plot_pop_up import \
    VisualizeClassificationProbabilityPopUp
from mufasa.ui.pop_ups.clf_validation_plot_pop_up import \
    ClassifierValidationPopUp
from mufasa.ui.pop_ups.coco_keypoints_to_yolo_popup import \
...
from mufasa.ui.pop_ups.dlc_h5_inference_to_yolo_popup import \
...
from mufasa.ui.pop_ups.labelme_to_df_popup import Labelme2DataFramePopUp
from mufasa.ui.pop_ups.labelme_to_imgs_popup import Labelme2ImgsPopUp
from mufasa.ui.pop_ups.make_path_plot_pop_up import MakePathPlotPopUp
from mufasa.ui.pop_ups.merge_coco_keypoint_files_pop_up import \
    MergeCOCOKeypointFilesPopUp
from mufasa.ui.pop_ups.movement_analysis_pop_up import \
    MovementAnalysisPopUp  # ## LAZY
from mufasa.ui.pop_ups.movement_analysis_time_bins_pop_up import \
...
from mufasa.ui.pop_ups.remove_roi_features_pop_up import RemoveROIFeaturesPopUp
from mufasa.ui.pop_ups.roi_aggregate_stats_popup import \
    ROIAggregateDataAnalyzerPopUp
from mufasa.ui.pop_ups.roi_analysis_time_bins_pop_up import \
...
from mufasa.ui.pop_ups.splash_popup import SplashMovie
from mufasa.ui.pop_ups.spontaneous_alternation_pop_up import \
    SpontaneousAlternationPopUp  # ## LAZY
from mufasa.ui.pop_ups.subset_feature_extractor_pop_up import \
    FeatureSubsetExtractorPopUp
from mufasa.ui.pop_ups.third_party_annotator_appender_pop_up import \
...
from mufasa.utils.lookups import (check_for_updates,
                                 get_bp_config_code_class_pairs,
                                 get_current_time, get_emojis, get_icons_paths,
                                 load_simba_fonts)
from mufasa.utils.read_write import (fetch_pip_data, find_core_cnt,
...
from mufasa.utils.warnings import (FFMpegNotFoundWarning, PythonVersionWarning,
                                  VersionWarning)
...
class SimbaProjectPopUp(ConfigReader, PopUpMixin):
    ...
    def __init__(self, config_path: Union[str, os.PathLike]):
        ...
        # Plotly/Dash interface removed: relied on cefpython3 (abandoned 2021)
        # and dash 1.x packages (dash_core_components, dash_html_components) that
        # were removed in dash 2.x. Code was already non-functional (see
        # generateSimBPlotlyFile which only emitted a "not available" warning).
        ...
        # (Plotly interface removed — see comment above.)
    ...
    # Plotly/Dash methods removed — the subsystem was unmaintained and
    # depended on abandoned packages (cefpython3 v66.0 / dash 1.x).
...
class App(object):
    def __init__(self):
        ...
        links_menu.add_command(label="SimBA Github", compound="left", image=self.menu_icons["github"]["img"], command=lambda: webbrowser.open_new(str(r"https://github.com/sgoldenlab/mufasa")), font=Formats.FONT_REGULAR.value)
        ...
        links_menu.add_command(label="SimBA API", compound="left", image=self.menu_icons["api"]["img"], command=lambda: webbrowser.open_new(str(r"https://mufasa-uw-tf-dev.readthedocs.io/")), font=Formats.FONT_REGULAR.value)

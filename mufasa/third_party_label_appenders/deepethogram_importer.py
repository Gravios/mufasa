...
class DeepEthogramImporter(ConfigReader):
    ...
    .. note::
       ...
       `Example expected input <https://github.com/sgoldenlab/mufasa/blob/master/misc/deep_ethogram_labels.csv>`__.
    ...
    .. [2] `Example DeepEthogram input file <https://github.com/sgoldenlab/mufasa/blob/master/misc/deep_ethogram_labels.csv>`__.
    """

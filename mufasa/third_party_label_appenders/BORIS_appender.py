...
class BorisAppender(ConfigReader):
    ...
    .. note::
       ...
       `Example I BORIS input file <https://github.com/sgoldenlab/mufasa/blob/master/misc/boris_example.csv>`_.
       `Example II BORIS input file <https://github.com/sgoldenlab/mufasa/blob/master/misc/boris_new_example.csv>`_.
    ...
    :example:
    >>> test = BorisAppender(config_path=r"C:\troubleshooting\boris_test\project_folder\project.toml", data_dir=r"C:\troubleshooting\boris_test\project_folder\boris_files")
    >>> test.run()

...
from mufasa.utils.warnings import MissingFileWarning
...
class YoloLabels2YoloProject:
    ...
    .. seealso::
       For COCO or other sources into YOLO layout, see other classes under :mod:`mufasa.third_party_label_appenders.transform`.
    ...
    :return: None (writes files on disk). :meth:`run` also prints success via :func:`mufasa.utils.printing.stdout_success`.

...
class COCOKeypoints2Yolo:
    ...
    .. note::
       ...
       :func:`mufasa.third_party_label_appenders.transform.utils.merge_coco_keypoints_files`.

    .. important::
       All image file names have to be unique.

    .. seealso::
      To convert COCO Keypoints version 1.0 data format into a YOLO bounding box training set, use :func:`mufasa.third_party_label_appenders.transform.coco_keypoints_to_yolo_bbox.COCOKeypoints2YoloBbox`.
      To train YOLO pose models with the converted data, see :func:`mufasa.model.yolo_fit.FitYolo` and `YOLO Pose Estimation Training Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/yolo_train.md>`_.
      To run inference with trained YOLO pose models, see :func:`mufasa.model.yolo_pose_inference.YOLOPoseInference` or :func:`mufasa.model.yolo_pose_track_inference.YOLOPoseTrackInference` and `YOLO Pose Estimation Inference Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/yolo_inference.md>`_.

...
class MergeYoloProjects:
    ...
    .. seealso::
       ...
       * :class:`~mufasa.third_party_label_appenders.transform.sam3_to_yolo_seg.SAM3ToYoloSeg`
       * :class:`~mufasa.third_party_label_appenders.transform.sam3_to_yolo_bbox.SAM3ToYoloBBox`

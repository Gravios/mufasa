...
class LabelmeBoundingBoxes2YoloBoundingBoxes:
    ...
    .. note::
       ...
       For an expected Labelme json format, see `THIS FILE <https://github.com/sgoldenlab/mufasa/blob/master/misc/labelme_ex.json>`_.
    ...
    .. seealso::
       ...
       To convert Labelme points annotations to YOLO keypoint training data, see :func:`mufasa.third_party_label_appenders.transform.labelme_to_yolo_keypoints.LabelmeKeypoints2YoloKeypoints`.

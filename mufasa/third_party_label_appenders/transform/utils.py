...
def merge_coco_keypoints_files(data_dir: str | os.PathLike,
    ...
    .. seealso::
       To convert COCO-format keypoint JSON to YOLO training set, see :func:`mufasa.third_party_label_appenders.transform.coco_keypoints_to_yolo.COCOKeypoints2Yolo`

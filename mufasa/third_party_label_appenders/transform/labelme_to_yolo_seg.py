...
class LabelmeKeypoints2YoloSeg:
    ...
    def __init__(self,
        ...
        .. seealso:
           To convert Labelme points annotations to YOLO bounding box training format data, see :func:`mufasa.third_party_label_appenders.transform.labelme_to_yolo.LabelmeBoundingBoxes2YoloBoundingBoxes`.

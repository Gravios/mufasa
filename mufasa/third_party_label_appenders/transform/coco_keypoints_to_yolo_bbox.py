...
class COCOKeypoints2YoloBbox:
    ...
    .. seealso::
      To convert OCO Keypoints version 1.0 data format into a YOLO keypoint training set, use :func:`mufasa.third_party_label_appenders.transform.coco_keypoints_to_yolo.COCOKeypoints2Yolo`

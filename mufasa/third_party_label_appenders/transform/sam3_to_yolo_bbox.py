...
class SAM3ToYoloBBox:
    ...
    .. note::
       To fit a YOLO detection model, see :class:`~mufasa.model.yolo_fit.FitYolo`.

    .. seealso::

       * :class:`~mufasa.third_party_label_appenders.transform.merge_yolo_projects.MergeYoloProjects` — merge multiple YOLO ``map.yaml`` projects into one training set.
       * :class:`~mufasa.third_party_label_appenders.transform.sam3_to_yolo_seg.SAM3ToYoloSeg` — SAM3 to YOLO **segmentation** labels from the same predictor stack.
    ...
    def __init__(self,
                 video_data: str | os.PathLike | list[str | os.PathLike],
                 sam_path: str | os.PathLike,

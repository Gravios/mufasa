...
class SAM3ToYoloSeg:
    ...
    .. note::
       To fit a YOLO segmentation model, see :class:`~mufasa.model.yolo_fit.FitYolo`.
       For YOLO segmentation inference, see :class:`~mufasa.model.yolo_seg_inference.YOLOSegmentationInference`.

...
class NoldusObserverImporter(ConfigReader):
    ...
    .. note::
       `Third-party import GitHub tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/third_party_annot.md>`__.
       `Expected input example 1 <https://github.com/sgoldenlab/mufasa/blob/master/misc/Observer_example_1.xlsx>`__.
       `Expected input example 2 <https://github.com/sgoldenlab/mufasa/blob/master/misc/Observer_example_2.xlsx>`__.

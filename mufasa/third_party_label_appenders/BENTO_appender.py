...
class BentoAppender(ConfigReader):
    ...
    .. note::
       `Example BENTO input file <https://github.com/sgoldenlab/mufasa/blob/master/misc/bento_example.annot>`_.
       'GitHub tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/third_party_annot.md>`_.

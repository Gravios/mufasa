...
class ThirdPartyLabelAppender(ConfigReader):
    ...
    ... note::
       `Third-party import tutorials <https://github.com/sgoldenlab/mufasa/blob/master/docs/third_party_annot.md>`__.

       `BENTO: expected input <https://github.com/sgoldenlab/mufasa/blob/master/misc/bento_example.annot`__.
       `BORIS: expected input <https://github.com/sgoldenlab/mufasa/blob/master/misc/boris_example.csv>`__.
       `DEEPETHOGRAM: expected input <https://github.com/sgoldenlab/mufasa/blob/master/misc/deep_ethogram_labels.csv>`__.
       `ETHOVISION: expected input <https://github.com/sgoldenlab/mufasa/blob/master/misc/ethovision_example.xlsx>`__.
       `OBSERVER: expected input I <https://github.com/sgoldenlab/mufasa/blob/master/misc/Observer_example_1.xlsx>`__.
       `OBSERVER: expected input II <https://github.com/sgoldenlab/mufasa/blob/master/misc/Observer_example_2.xlsx>`__.
       `SOLOMON: expected input II <https://github.com/sgoldenlab/mufasa/blob/master/misc/solomon_example.csv>`__.
...
#
# test = ThirdPartyLabelAppender(config_path=r"/Users/simon/Desktop/envs/mufasa/troubleshooting/boris_beeteamlmg/project_folder/project_config.ini",
#                                data_dir=r"/Users/simon/Desktop/envs/mufasa/troubleshooting/boris_beeteamlmg/boris_data",
#                                app='BORIS',
#                                file_format='.csv',
#                                error_settings=error_settings,
#                                log=log)

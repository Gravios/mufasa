...
class GanttCreatorMultiprocess(ConfigReader, PlottingMixin):
    ...
    :example:
        >>> gantt_creator = GanttCreatorMultiprocess(config_path='project.toml', video_setting=True, data_paths=['derived/classifications/video1.parquet'], core_cnt=5, hhmmss=True, last_frm_setting=True)
        >>> gantt_creator.run()
    """

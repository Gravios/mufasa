...
class DistancePlotterSingleCore(ConfigReader):
    ...
    .. note::
       For better runtime, use :meth:`mufasa.plotting.distance_plotter_mp.DistancePlotterMultiCore`.
       `GitHub tutorial/documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-11-visualizations>`__.
...
# test = DistancePlotterSingleCore(config_path=r'/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini',
#                                  frame_setting=True,
#                                  video_setting=True,
#                                  style_attr=style_attr,
#                                  final_img=True,
#                                  data_paths=['/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/csv/outlier_corrected_movement_location/Together_1.csv'],
#                                  line_attr=line_attr)
# test.run()

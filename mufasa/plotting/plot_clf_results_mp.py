...
from mufasa.utils.data import (check_if_string_value_is_valid_video_timestamp,
...
def _multiprocess_sklearn_video(data: pd.DataFrame,
                                ...
                                clf_confidence: dict | None,
                                show_pose: bool,
                                show_animal_names: bool,
                                bbox: Literal['axis-aligned', 'animal-aligned'] | None,
                                circle_size: int,
                                font_size: int,
                                space_size: int,
                                text_thickness: int,
...
class PlotSklearnResultsMultiProcess(ConfigReader, TrainModelMixin, PlottingMixin):
    ...
    .. seealso::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-10-sklearn-visualization>`__.
       For single-core processing, see :meth:`mufasa.plotting.plot_clf_results.PlotSklearnResultsSingleCore`.
    ...
    :param Optional[str] pose_palette: Name of color palette for pose keypoints. Must be from :class:`mufasa.utils.enums.Options.PALETTE_OPTIONS_CATEGORICAL` or :class:`mufasa.utils.enums.Options.PALETTE_OPTIONS`. Default 'Set1'.
    ...
    def __init__(self,
                 ...
                 print_timer: Literal['seconds', 'hh:mm:ss.ssss'] | None = 'seconds',
                 overwrite: bool = True,
    ...
    def run(self):
        ...
        for video_cnt, video_path in enumerate(self.video_paths):
            ...
            # downstream rendering needs contiguous int index +
            # NaN-free predictions (same constraint as the
            # single-core sibling in 122av).
...
#     clf_plotter = PlotSklearnResultsMultiProcess(config_path=r"E:\troubleshooting\mitra_emergence_hour\project_folder\project.toml",
...
# if __name__ == "__main__":
#     clf_plotter = PlotSklearnResultsMultiProcess(config_path=r"F:\troubleshooting\sam\sam\project_folder\project.toml",
...
# if __name__ == "__main__":
#     clf_plotter = PlotSklearnResultsMultiProcess(config_path=r"F:\troubleshooting\sophiaa\project_folder\project.toml",
#                                                 video_setting=True,
#                                                 frame_setting=False,
...
# if __name__ == "__main__":
#     clf_plotter = PlotSklearnResultsMultiProcess(config_path=r"C:\troubleshooting\mitra\project_folder\project.toml",
#                                                  video_setting = True,
#                                                  frame_setting = False,
#                                                  rotate = False,
#                                                  core_cnt = 6,

...
class EzPathPlot(object):
    ...
    .. seealso::
       For batch processing with more options and optional multiprocessing, use :class:`mufasa.plotting.path_plotter.PathPlotterSingleCore` or :class:`mufasa.plotting.path_plotter_mp.PathPlotterMulticore`.

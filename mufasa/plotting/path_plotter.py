...
class PathPlotterSingleCore(ConfigReader, PlottingMixin):
    ...
    .. note::
        For improved run-time, see :meth:`mufasa.path_plotter_mp.PathPlotterMulticore` for multiprocess class.

       `Visualization tutorials <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-11-visualizations>`__.

       `Notebook example <https://mufasa-uw-tf-dev.readthedocs.io/en/latest/nb/path_plots.html>`__.
    ...
    >>> path_plotter = PathPlotterSingleCore(config_path=r'MyConfigPath', frame_setting=False, video_setting=True, style_attr=style_attr, animal_attr=animal_attr, files_found=['project_folder/derived/classifications/MyVideo.parquet'], print_animal_names=True).run()
...
# style_attr = None
# test = PathPlotterSingleCore(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/RAT_NOR/project_folder/project_config.ini',
#                              frame_setting=False,
#                              video_setting=True,
#                              last_frame=True,
...
#                              print_animal_names=False,
#                              roi=True,
#                              files_found=['/Users/simon/Desktop/envs/mufasa/troubleshooting/RAT_NOR/project_folder/csv/outlier_corrected_movement_location/2022-06-20_NOB_DOT_4.csv'])
# test.run()

# test = PathPlotterSingleCore(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini',
#                              frame_setting=False,
#                              video_setting=True,
#                              last_frame=True,
#                              input_style_attr=style_attr,

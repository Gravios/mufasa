...
class TresholdPlotCreatorSingleProcess(ConfigReader, PlottingMixin):
    ...
    .. note::
       `Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-11-visualizations>`_.
       For improved run-time, use :meth:`mufasa.plotting.probability_plot_creator_mp.TresholdPlotCreatorMultiprocess`

...
class PlotSklearnResultsSingleCore(ConfigReader, TrainModelMixin, PlottingMixin):
    ...
    .. note::
       For improved run-time, see :meth:`mufasa.plotting.plot_clf_results_mp.PlotSklearnResultsMultiProcess` for multiprocess class.
       Scikit visualization documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-10-sklearn-visualization__.
    ...
    >>> test = PlotSklearnResultsSingleCore(config_path='/path/to/mufasa/troubleshooting/two_black_animals_14bp/project.toml',
    >>>                                       video_setting=True,
    >>>                                       frame_setting=False,

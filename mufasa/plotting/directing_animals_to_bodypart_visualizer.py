...
class DirectingAnimalsToBodyPartVisualizer(ConfigReader, PlottingMixin):
    ...
    .. important::
       ...
       For better runtime, use :meth:`mufasa.plotting.Directing_animals_visualizer.DirectingOtherAnimalsVisualizerMultiprocess`.

    .. note::
       `Example of expected output <https://www.youtube.com/watch?v=d6pAatreb1E&list=PLi5Vwf0hhy1R6NDQJ3U28MOUJPfl2YWYl&index=22`_.

        `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#visualizing-data-tables`>_.
    ...
    >>> _ = DirectingAnimalsToBodyPartVisualizer(config_path='/path/to/troubleshooting/sleap_5_animals/project.toml', video_name='Testing_Video_3.mp4', style_attr=style_attr).run()
    """
...
# _ = DirectingAnimalsToBodyPartVisualizer(config_path='/path/to/mufasa/troubleshooting/two_black_animals_14bp/project.toml', data_path='/path/to/mufasa/troubleshooting/two_black_animals_14bp/project_folder/csv/outlier_corrected_movement_location/Together_1.csv', style_attr=style_attr).run()

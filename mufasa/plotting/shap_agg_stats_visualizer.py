...
class ShapAggregateStatisticsCalculator():
    ...
    .. note::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/SHAP.md#step-3-interpreting-the-shap-value-ouput-generated-by-mufasa>`__.
       `Example output <https://github.com/sgoldenlab/mufasa/blob/master/images/example_shap_graph.png>`__.
    ...
    :param float shap_baseline_value: SHAP expected value (computed by ``mufasa.train_model_functions.create_shap_log``).

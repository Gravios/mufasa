...
class DirectingOtherAnimalsVisualizer(ConfigReader, PlottingMixin):
    ...
    For faster processing of large videos, use :class:`~mufasa.plotting.directing_animals_visualizer_mp.DirectingOtherAnimalsVisualizerMultiprocess`.

    .. important::
       Requires pose-estimation data for left ear, right ear, and nose of each animal. Project must contain at least 2 animals.

    .. note::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#visualizing-data-tables>`__.
    ...
    .. seealso::
       For improved runtime, consider multiprocess class at :func:`mufasa.plotting.directing_animals_visualizer_mp.DirectingOtherAnimalsVisualizerMultiprocess`.
    ...
    :example:
        ...
        >>> visualizer = DirectingOtherAnimalsVisualizer(config_path='project.toml', video_path='video.avi', style_attr=style_attr)
        >>> visualizer.run()
    """

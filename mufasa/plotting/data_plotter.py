...
class DataPlotter(ConfigReader):
    ...
    def __init__(self,
        ...
        if (not video_setting) and (not frame_setting):
            raise NoSpecifiedOutputError(msg="Please choose to create video and/or frames data plots. Mufasa found that you ticked neither video and/or frames", source=self.__class__.__name__)

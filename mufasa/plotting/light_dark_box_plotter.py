...
class LightDarkBoxPlotter():
    ...
    .. seealso::
       For light/dark box data analysis, see :func:`mufasa.data_processors.light_dark_box_analyzer.LightDarkBoxAnalyzer`.
    ...
    :references:
       .. [1] For discussion about the development, see - `GitHub issue 446 <https://github.com/sgoldenlab/mufasa/issues/446#issuecomment-2930692735>`_.
    """

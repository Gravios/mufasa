...
class ROIfeatureVisualizer(ConfigReader):
    ...
    .. note::
       For improved run-time, see :meth:`mufasa.ROI_feature_visualizer_mp.ROIfeatureVisualizerMultiprocess` for multiprocess class.
    ...
    >>> test = ROIfeatureVisualizer(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/RAT_NOR/project_folder/project_config.ini', video_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/RAT_NOR/project_folder/videos/2022-06-20_NOB_DOT_4.mp4', style_attr=style_attr, body_parts=['Nose'])
    >>> test.run()
    """

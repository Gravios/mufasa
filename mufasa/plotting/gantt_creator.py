...
class GanttCreatorSingleProcess(ConfigReader, PlottingMixin):
    ...
    :example:
        >>> gantt_creator = GanttCreatorSingleProcess(config_path='project_config.ini', video_setting=True, data_paths=['derived/classifications/video1.parquet'], hhmmss=True, last_frm_setting=True)
        >>> gantt_creator.run()
    """

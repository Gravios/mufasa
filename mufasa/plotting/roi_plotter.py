...
class ROIPlotter(ConfigReader):
    ...
    .. seealso::
       Use :func:`mufasa.plotting.ROI_plotter_mp.ROIPlotMultiprocess` for improved run-time.
    ...
    :example:
    >>> test = ROIPlotter(config_path=r'/Users/simon/Desktop/envs/mufasa/troubleshooting/mouse_open_field/project_folder/project_config.ini',
    ...
    def __init__(self,
        ...
        if data_path is None:
            ...
            if not os.path.isfile(data_path):
                raise NoFilesFoundError(msg=f"Could not find the file at path {data_path}. Make sure the data file exist to create ROI visualizations",  source=self.__class__.__name__)

...
class HeatMapperClfSingleCore(ConfigReader, PlottingMixin):
    ...
    .. note::
       ...
       For improved run-time, see :meth:`mufasa.heat_mapper_clf_mp.HeatMapperClfMultiprocess` for multiprocess class.
    ...
    :example:
    >>> test = HeatMapperClfSingleCore(config_path=r"C:\troubleshooting\RAT_NOR\project_folder\project.toml",

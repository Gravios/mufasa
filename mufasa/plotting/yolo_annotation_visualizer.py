...
class YOLOAnnotationVisualizer(object):
    ...
    .. seealso::
       For visualizing YOLO bounding-box inference results on video, see :func:`mufasa.plotting.yolo_visualize.YOLOVisualizer`.
       For visualizing YOLO keypoint pose-estimation results on video, see :func:`mufasa.plotting.yolo_pose_visualizer.YOLOPoseVisualizer`.
       For visualizing YOLO segmentation polygon results on video, see :func:`mufasa.plotting.yolo_seg_visualizer.YOLOSegmentationVisualizer`.
       For auto-detecting the YOLO project type from a label file, see :func:`mufasa.utils.yolo.detect_yolo_project_type`.

...
class HeatMapperLocationMultiprocess(ConfigReader, PlottingMixin):
    ...
    >>> heatmapper = HeatMapperLocationMultiprocess(config_path='project.toml', data_paths='csv/outlier_corrected_movement_location/Together_1.csv', bodypart='Nose_1', style_attr=style_attr, core_cnt=-1, final_img_setting=True, video_setting=False, frame_setting=False)
    >>> heatmapper.run()
    """

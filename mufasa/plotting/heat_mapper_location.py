...
class HeatmapperLocationSingleCore(ConfigReader, PlottingMixin):
    ...
    For improved run-time, see :meth:`mufasa.heat_mapper_location_mp.HeatMapperLocationMultiprocess` for multiprocess class.

    ..note::
       `GitHub visualizations tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-11-visualizations>`__.
        For improved run-time of videos, see :meth:`mufasa.heat_mapper_location_mp.HeatMapperLocationMultiprocess` for multiprocess class.
...
# test = HeatmapperLocationSingleCore(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/platea/project_folder/project_config.ini',
#                                       style_attr = {'palette': 'jet', 'shading': 'flat', 'bin_size': 30, 'max_scale': 2},
#                                       final_img_setting=True,
#                                       video_setting=True,
#                                       frame_setting=False,
#                                       bodypart='CENTER',
#                                       data_paths=['/Users/simon/Desktop/envs/mufasa/troubleshooting/platea/project_folder/csv/outlier_corrected_movement_location/Video_1.csv'])
# test.run()
...
# test = HeatmapperLocationSingleCore(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/open_field_below/project_folder/project_config.ini',
#                                       style_attr = {'palette': 'jet', 'shading': 'gouraud', 'bin_size': 100, 'max_scale': 10},
#                                       final_img_setting=True,
#                                       video_setting=True,
#                                       frame_setting=False,
#                                       bodypart='Snout',
#                                       data_paths=['/Users/simon/Desktop/envs/mufasa/troubleshooting/open_field_below/project_folder/csv/outlier_corrected_movement_location/raw_clip1.csv'])
# test.run()
...
#
# test = HeatmapperLocationSingleCore(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini',
#                                       style_attr = {'palette': 'jet', 'shading': 'gouraud', 'bin_size': 100, 'max_scale': 'auto'},
#                                       final_img_setting=True,
#                                       video_setting=True,
#                                       frame_setting=False,
#                                       bodypart='Nose_1',
#                                       files_found=['/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/csv/outlier_corrected_movement_location/Together_1.csv'])
# test.run()

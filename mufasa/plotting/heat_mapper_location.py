...
class HeatmapperLocationSingleCore(ConfigReader, PlottingMixin):
    ...
    >>> heatmapper = HeatmapperLocationSingleCore(config_path='/path/to/troubleshooting/two_black_animals_14bp/project.toml', style_attr = style_attr, final_img_setting=True, video_setting=True, frame_setting=False, bodypart='Nose_1', files_found=['/path/to/troubleshooting/two_black_animals_14bp/project_folder/derived/classifications/Together_1.parquet'])
    >>> heatmapper.run()
    """

...
class BlobVisualizer():
    ...
    ..seealso::
       To create blob data, see :func:`mufasa.video_processors.blob_tracking_executor.BlobTrackingExecutor`
       To import blob data into SimBA project, see :func:`mufasa.pose_importers.simba_blob_importer.SimBABlobImporter`

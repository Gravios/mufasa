...
class PlotAnnotatedBouts(ConfigReader, TrainModelMixin, PlottingMixin):
    ...
    def __init__(self,
                 ...
                 data_paths: list[str | os.PathLike] | str | os.PathLike | None = None,
                 animal_names: bool = False,
                 show_pose: bool = True,
                 pre_window: float | None = None,
                 post_window: float | None = None,
                 ...
                 video_timer: Literal['seconds', 'hh:mm:ss.ssss'] | None = 'hh:mm:ss.ssss',
                 overwrite: bool = True,

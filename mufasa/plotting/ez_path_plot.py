...
class EzPathPlot(object):
    ...
    .. note::
       For more refined / complex path plots with/without multiprocessing for inproved speed, see ``mufasa.plotting.path_plotter.PathPlotterSingleCore`` and ``mufasa.plotting.path_plotter_mp.PathPlotterMulticore``.

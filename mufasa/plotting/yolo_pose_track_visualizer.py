...
class YOLOPoseTrackVisualizer():
    ...
    .. seealso::
       - :func:`~mufasa.bounding_box_tools.yolo.yolo_pose_inference.YOLOPoseInference` for generating YOLO pose CSV data.
       - :func:`~mufasa.model.yolo_fit.FitYolo` for fitting YOLO detector models.
       - Tracker configuration templates in :mod:`mufasa.assets.tracker_yml`.

...
from mufasa.utils.read_write import concatenate_videos_in_folder, find_core_cnt, get_fn_ext
...
class TresholdPlotCreatorMultiprocess(ConfigReader, PlottingMixin):
    ...
    :example:
    >>> plot_creator = TresholdPlotCreatorMultiprocess(config_path='/path/to/troubleshooting/train_model_project/project.toml', frame_setting=True, video_setting=True, clf_name='Attack', style_attr={'width': 640, 'height': 480, 'font size': 10, 'line width': 6, 'color': 'magneta', 'circle size': 20}, cores=5)
    >>> plot_creator.run()
    """

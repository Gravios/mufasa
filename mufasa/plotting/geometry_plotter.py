...
def geometry_visualizer(data: tuple[int, pd.DataFrame],
                        ...
                        video_temp_dir: str | os.PathLike,
                        video_meta_data: dict,
                        thickness: int,
                        verbose: bool,
                        outline_clr: tuple[int, int, int] | None,
                        intersection_clr: tuple[int, int, int] | None,
                        bg_opacity: float,
                        colors: list,
                        circle_size: int,
                        shape_opacity: float):
...
class GeometryPlotter(ConfigReader, PlottingMixin):
    ...
    .. seealso::
       To quickly create static geometries on a white background (useful for troubleshooting unexpected geometries), see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.view_shapes`
       and :func:`mufasa.mixins.geometry_mixin.GeometryMixin.geometry_video`
    ...
    def __init__(self,
                 geometries: list[list[Polygon | LineString | MultiPolygon | MultiLineString | Point]],
                 video_name: str | os.PathLike,
                 ...
                 intersection_clr: tuple[int, int, int] | None = None,
                 bg_opacity: float | None = 1,
                 shape_opacity: float = 0.3,
                 outline_clr: tuple[int, int, int] | None = None,
...
#     from mufasa.utils.read_write import read_pickle

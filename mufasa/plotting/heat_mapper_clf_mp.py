...
class HeatMapperClfMultiprocess(ConfigReader, PlottingMixin):
    ...
    >>> heatmapper = HeatMapperClfMultiprocess(config_path='project.toml', bodypart='Nose_1', clf_name='Attack', data_paths=['derived/classifications/Video1.parquet'], style_attr=style_attr, final_img_setting=True, video_setting=False, frame_setting=False, core_cnt=-1)
    >>> heatmapper.run()
    """

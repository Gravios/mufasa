...
class InferenceValidation(ConfigReader, TrainModelMixin):
    ...
    .. note::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#part-3-run-the-classifier-on-new-data>`_
...
#
# ValidateModelRunClf(config_path=r"Z:\DeepLabCut\DLC_extract\Troubleshooting\DLC_two_mice\project_folder\project.toml",

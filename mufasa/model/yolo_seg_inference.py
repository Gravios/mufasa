...
class YOLOSegmentationInference():
    ...
    .. note::
       To **create** YOLO segmentation dataset for fitting, use :func:`mufasa.third_party_label_appenders.transform.labelme_to_yolo_seg.LabelmeKeypoints2YoloSeg`.
       To fit YOLO model, see `:func:`mufasa.model.yolo_fit.FitYolo`.
       To visualize the segmentation results, see :func:`mufasa.plotting.yolo_seg_visualizer.YOLOSegmentationVisualizer`

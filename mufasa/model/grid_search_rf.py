...
class GridSearchRandomForestClassifier(ConfigReader, TrainModelMixin):
    ...
    .. note::
       Searches the SimBA project ``project_folder/configs`` directory for meta files and builds one model per valid config file. `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario1.md#step-7-train-machine-model>`__.
...
# test = GridSearchRandomForestClassifier(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/open_field_below/project_folder/project_config.ini')
# test.run()

# test = GridSearchRandomForestClassifier(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')
# test.run()

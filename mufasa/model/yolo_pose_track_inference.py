...
from mufasa.utils.yolo import _get_undetected_obs, filter_yolo_keypoint_data, load_yolo_model
...
class YOLOPoseTrackInference:
    ...
    .. seealso::
       For pose inference without tracks, see :func:`mufasa.model.yolo_pose_inference.YOLOPoseInference`.
       For visualizing pose tracks, see :func:`mufasa.plotting.yolo_pose_track_visualizer.YOLOPoseTrackVisualizer`.
       If you do not need tracks (have individually idenitifiable individuals) use :func:`mufasa.plotting.yolo_pose_track_visualizer.YOLOPoseTrackVisualizer` for better runtimes.
    ...
    def __init__(self,
                 ...
                 threshold: float = 0.7,
                 max_tracks: int | None = 2,
                 smoothing: int | None = None,
                 randomize_order: bool | None = False,
                 n: int | None = None,
                 imgsz: int = 320,
                 min_video_size: float | None = None,
                 overwrite: bool = True,
                 iou: float = 0.5,
...
# BOTSORT_PATH = r"C:\projects\mufasa\mufasa\mufasa\assets\tracker_yml\tow_bytetrack.yaml"
#

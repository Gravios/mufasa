...
class FitYolo():
    ...
    .. note::
       ...
       - Example dataset YAMLs: `bbox <https://github.com/sgoldenlab/mufasa/blob/master/misc/ex_yolo_model.yaml>`__, `pose <https://github.com/sgoldenlab/mufasa/blob/master/misc/ex_yolo_model_keypoints.yaml>`__.
    ...
    .. seealso::
       :func:`mufasa.bounding_box_tools.yolo.utils.fit_yolo` for the functional API.
       :func:`mufasa.bounding_box_tools.yolo.utils.load_yolo_model` to load trained weights.
       For  instructions, see `YOLO Pose Estimation Training Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/yolo_train.md>`_.
    ...
    :param Optional[str] format: Optional weights format override. Must belong to :class:`mufasa.utils.enums.Options.VALID_YOLO_FORMATS`. Default ``None``.
    ...
    def run(self):
        stdout_information(msg=f'[{get_current_time()}] Please follow the YOLO pose model training in the terminal from where Mufasa was launched ...', source=self.__class__.__name__)

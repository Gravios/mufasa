...
from mufasa.utils.enums import (ConfigKey, Dtypes, Formats, Links, Methods,
                               MLParamKeys, Options)
...
from mufasa.utils.read_write import read_config_entry, str_2_bool, write_df
...
class TrainRandomForestClassifier(ConfigReader, TrainModelMixin):
    ...
    .. note::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario1.md#step-7-train-machine-model>`_
...
# test = TrainRandomForestClassifier(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/mouse_open_field/project_folder/project_config.ini')
# test.run()
# test.save()

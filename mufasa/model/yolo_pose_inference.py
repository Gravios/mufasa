...
class YOLOPoseInference():
    ...
    .. seealso::
       For bounding box inference only (no pose), see :func:`mufasa.model.yolo_inference.YoloInference`.
       For segmentation inference, see :func:`mufasa.model.yolo_seg_inference.YOLOSegmentationInference`.
       To fit YOLO model, see `:func:`mufasa.model.yolo_fit.FitYolo`.
       For detailed instructions, see `YOLO Pose Estimation Inference Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/yolo_inference.md>`_.

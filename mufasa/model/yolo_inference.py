...
from mufasa.third_party_label_appenders.converters import yolo_obb_data_to_bounding_box
...
from mufasa.utils.errors import InvalidVideoFileError, MufasaGPUError, MufasaPackageVersionError
...
class YoloInference:
    ...
    .. seealso::
       To perform bounding box and **keypoint (pose) detection**, see :func:`~mufasa.bounding_box_tools.yolo.yolo_pose_inference.YOLOPoseInference`.
       To perform keypoint (pose) detection with tracking, see :func:`~mufasa.model.yolo_pose_track_inference.YOLOPoseTrackInference`
       To visualize bounding boxes only, see :func:`~mufasa.plotting.yolo_visualize.YOLOVisualizer`

...
class AggregateClfCalculatorMultiprocess(ConfigReader):
    ...
    .. seealso::
       For single core class, see :func:`mufasa.data_processors.agg_clf_calculator.AggregateClfCalculator`

    .. note::
       `GitHub tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#part-4--analyze-machine-results>`__.
       `Example expected output file <https://github.com/sgoldenlab/mufasa/blob/master/misc/detailed_bout_data_summary_20231011091832.csv>`__.
    ...
    def save(self) -> None:
        """
        Method to save classifier aggregate statistics created in :meth:`~mufasa.ClfLogCreator.analyze_data` to disk.

...
class PupRetrieverCalculator(ConfigReader):
    ...
    .. note::
       `Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/add_on_pup_ret.md>`_
    ...
    >>> config_path = '/Users/simon/Downloads/Automated PRT_test/project.toml'

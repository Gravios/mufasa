...
class TimeBinsMovementCalculator(ConfigReader, FeatureExtractionMixin):
    ...
    .. note::
        `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#part-4--analyze-machine-results>`__.
    ...
    .. seealso::
       For multicore processing, see :class:`mufasa.data_processors.timebins_movement_calculator_mp.TimeBinsMovementCalculator`.
    ...
    :example:
    >>> calculator = TimeBinsMovementCalculator(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini', bin_length=0.04, plots=True, body_parts=['Nose_1', 'Nose_2'])
    >>> calculator.run()
    """

...
class DirectingAnimalsToBodyPartAnalyzer(ConfigReader, FeatureExtractionMixin):
    ...
    .. important::
       ...
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/ROI_tutorial.md#part-3-generating-features-from-roi-data>`__.
    ...
    def create_directionality_dfs(self):
        """
        Method to transpose results created by :meth:`~mufasa.DirectingOtherAnimalsAnalyzer.process_directionality`.
    ...
    def save_directionality_dfs(self):
        """
        Method to save result created by :meth:`~mufasa.DirectingOtherAnimalsAnalyzer.create_directionality_dfs`.
    ...
    def summary_statistics(self):
        """
        Method to save aggregate statistics of data created by :meth:`~mufasa.DirectingOtherAnimalsAnalyzer.create_directionality_dfs`.
        into CSV files on disk. Results are stored in `project_folder/logs` directory of the SimBA project.

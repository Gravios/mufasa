...
class SeverityFrameCalculator(ConfigReader, FeatureExtractionMixin):
    ...
    .. note::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md>`__.
...
#             'video_speed': 0.1,
#             'show_pose': True}
# processor = SeverityFrameCalculator(config_path='/path/to/troubleshooting/two_black_animals_14bp/project.toml', settings=settings)
# processor.run()

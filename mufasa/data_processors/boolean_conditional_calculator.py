...
class BooleanConditionalCalculator(ConfigReader):
    ...
    .. note:
       `Example expected aggregate output table <https://github.com/sgoldenlab/mufasa/blob/master/misc/Conditional_aggregate_statistics_20231004130314.csv>`__.
       `Example expected detailed output table <https://github.com/sgoldenlab/mufasa/blob/master/misc/Detailed_conditional_aggregate_statistics_20241011123409.csv>`__.
    ...
    >>> conditional_bool_rule_calculator = BooleanConditionalCalculator(rules=rules, config_path='/path/to/troubleshooting/two_animals_16bp_032023/project.toml')

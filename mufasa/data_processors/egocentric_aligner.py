...
class EgocentricalAligner():
    ...
    .. seealso::
       To produce rotation vectors, uses :func:`~mufasa.utils.data.egocentrically_align_pose_numba` or :func:`~mufasa.utils.data.egocentrically_align_pose`.
       To rotate video only, see :func:`~mufasa.video_processors.egocentric_video_rotator.EgocentricVideoRotator`

...
class DirectingOtherAnimalsAnalyzer(ConfigReader, FeatureExtractionMixin):
    ...
    .. note::
       `Example expected bool table <https://github.com/sgoldenlab/mufasa/blob/master/misc/boolean_directionaly_example.csv>`__.
       `Example expected summary table <https://github.com/sgoldenlab/mufasa/blob/master/misc/detailed_summary_directionality_example.csv>`__.
       `Example expected aggregate statistics table <https://github.com/sgoldenlab/mufasa/blob/master/misc/direction_data_aggregates_example.csv>`__.

    .. important::
       Requires the pose-estimation data for the ``left ear``, ``right ear`` and ``nose`` of each individual animals.
       `Github Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/ROI_tutorial.md#part-3-generating-features-from-roi-data>`__.
       `Expected output <https://github.com/sgoldenlab/mufasa/blob/master/misc/Direction_data_example.csv>`__.

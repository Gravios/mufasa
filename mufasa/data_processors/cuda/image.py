...
# Linux-only as of Mufasa 6.0; rely on the default fork start method.
# Previously: ``if platform.system() != OS.WINDOWS.value: mp.set_start_method("spawn", force=True)``
...
def create_average_frm_cupy(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.video_processors.video_processing.create_average_frm`.
       For CUDA function see :func:`~mufasa.data_processors.cuda.image.create_average_frm_cuda`
...
def create_average_frm_cuda(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For CuPy function see :func:`~mufasa.data_processors.cuda.image.create_average_frm_cupy`.
       For CPU function see :func:`~mufasa.video_processors.video_processing.create_average_frm`.
...
def img_stack_brightness(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.image_mixin.ImageMixin.brightness_intensity`.
...
def stack_sliding_mse(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.image_mixin.ImageMixin.img_stack_mse` and
       :func:`~mufasa.mixins.image_mixin.ImageMixin.img_sliding_mse`.
...
def img_stack_to_grayscale_cupy(imgs: Union[np.ndarray, cp.ndarray],
    ...
    .. seealso::
       For CPU function single images :func:`~mufasa.mixins.image_mixin.ImageMixin.img_to_greyscale` and
       :func:`~mufasa.mixins.image_mixin.ImageMixin.img_stack_to_greyscale` for stack. For CUDA JIT, see
       :func:`~mufasa.data_processors.cuda.image.img_stack_to_grayscale_cuda`.
...
def img_stack_to_grayscale_cuda(x: np.ndarray) -> np.ndarray:
    ...
    .. seealso::
       For CPU function single images :func:`~mufasa.mixins.image_mixin.ImageMixin.img_to_greyscale` and
       :func:`~mufasa.mixins.image_mixin.ImageMixin.img_stack_to_greyscale` for stack. For CuPy, see
       :func:`~mufasa.data_processors.cuda.image.img_stack_to_grayscale_cupy`.
...
def img_stack_to_bw(imgs: np.ndarray,
    ...
    .. seealso::
       :func:`mufasa.mixins.image_mixin.ImageMixin.img_to_bw`
       :func:`mufasa.mixins.image_mixin.ImageMixin.img_stack_to_bw`
...
def segment_img_stack_vertical(imgs: np.ndarray,
    ...
    .. seealso::
       :func:`mufasa.mixins.image_mixin.ImageMixin.segment_img_vertical`
...
def segment_img_stack_horizontal(imgs: np.ndarray,
    ...
    .. seealso::
       :func:`mufasa.mixins.image_mixin.ImageMixin.segment_img_stack_horizontal`
...
def _get_bboxes(shapes):
    """
    Helper to get geometries in :func:`mufasa.data_processors.cuda.image.slice_imgs`.
    """
    bboxes = []
    for shape in shapes:
...
def slice_imgs(video_path: Union[str, os.PathLike],
    ...
    .. video:: _static/img/mufasa.sandbox.cuda_slice_w_crop.slice_imgs.webm
       :width: 900
       :loop:
       :muted:
       :align: center
    ...
    .. note::
       For CPU multicore implementation, see :func:`mufasa.mixins.image_mixin.ImageMixin.slice_shapes_in_imgs`.
       For single core process, see :func:`mufasa.mixins.image_mixin.ImageMixin.slice_shapes_in_img`
...
def bg_subtraction_cuda(video_path: Union[str, os.PathLike],
    ...
    .. note::
       To create an `avg_frm`, use :func:`mufasa.video_processors.video_processing.create_average_frm`, :func:`mufasa.data_processors.cuda.image.create_average_frm_cupy`, or :func:`~mufasa.data_processors.cuda.image.create_average_frm_cuda`

    .. seealso::
       For CPU-based alternative, see :func:`mufasa.video_processors.video_processing.video_bg_subtraction` or :func:`~mufasa.video_processors.video_processing.video_bg_subtraction_mp`
       For GPU-based alternative, see :func:`~mufasa.data_processors.cuda.image.bg_subtraction_cupy`. Needs work, CPU/multicore appears faster.

    .. seealso::
       To create average frame on the CPU, see :func:`mufasa.video_processors.video_processing.create_average_frm`. CPU/multicore appears faster.
    ...
    :param np.ndarray avg_frm: Average frame of the video. Can be created with e.g., :func:`mufasa.video_processors.video_processing.create_average_frm`.
...
def bg_subtraction_cupy(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For CPU-based alternative, see :func:`mufasa.video_processors.video_processing.video_bg_subtraction` or :func:`~mufasa.video_processors.video_processing.video_bg_subtraction_mp`
       For GPU-based alternative, see :func:`~mufasa.data_processors.cuda.image.bg_subtraction_cuda`.
...
def pose_plotter(data: Union[str, os.PathLike, np.ndarray],
    ...
    .. seealso::
       For CPU based methods, see :func:`~mufasa.plotting.path_plotter.PathPlotterSingleCore` and :func:`~mufasa.plotting.path_plotter_mp.PathPlotterMulticore`.
...
#
# #from mufasa.data_processors.cuda.image import create_average_frm_cupy

...
def is_inside_rectangle(x: np.ndarray, y: np.ndarray) -> np.ndarray:
    ...
    .. image:: _static/img/mufasa.data_processors.cuda.geometry.is_inside_rectangle.webp
       :width: 450
       :align: center
    ...
    .. seealso::
       For numba CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_inside_rectangle_roi`
...
def is_inside_polygon(x: np.ndarray, y: np.ndarray) -> np.ndarray:
    ...
    .. image:: _static/img/mufasa.data_processors.cuda.geometry.is_inside_polygon.webp
       :width: 450
       :align: center
    ...
    .. seealso::
       For jitted CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_inside_polygon_roi`
...
def get_convex_hull(pts: np.ndarray) -> np.ndarray:
    ...
    .. seealso::
       :func:`~mufasa.feature_extractors.perimeter_jit.jitted_hull`.
       :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.convex_hull_calculator_mp`.
...
def poly_area(data: np.ndarray,
    ...
    .. image:: _static/img/mufasa.data_processors.cuda.geometry.poly_area_cuda.webp
       :width: 450
       :align: center
...
def find_midpoints(x: np.ndarray,
    ...
    .. seealso:
       For CPU function see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.find_midpoints`.
...
def directionality_to_static_targets(left_ear: np.ndarray,
    ...
    .. seealso::
        For numba based CPU method, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.jitted_line_crosses_to_static_targets`
...
def directionality_to_nonstatic_target(left_ear: np.ndarray,
    ...
    .. seealso::
       ...
       For non-GPU numba based CPU method, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.jitted_line_crosses_to_nonstatic_targets`
       ...
       or :func:`mufasa.data_processors.cuda.geometry.directionality_to_static_targets` for GPU acceleration.

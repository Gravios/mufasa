...
def get_3pt_angle(x: np.ndarray, y: np.ndarray, z: np.ndarray) -> np.ndarray:
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt` and
       For CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt_serialized`.
...
def count_values_in_ranges(x: np.ndarray, r: np.ndarray) -> np.ndarray:
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.count_values_in_range`.
...
def get_euclidean_distance_cuda(x: np.ndarray, y: np.ndarray) -> np.ndarray:
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`.
       For CuPY function see :func:`~mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy`.
...
def get_euclidean_distance_cupy(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`.
       For CUDA JIT function see :func:`~mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`.
...
def sliding_spearmans_rank(x: np.ndarray,
    ...
    .. seealso::
       ...
       For CPU function see :func:`~mufasa.mixins.statistics.StatisticsMixin.sliding_spearman_rank_correlation`.
...
def euclidean_distance_to_static_point(data: np.ndarray,
    ...
    .. seealso::
       For CPU-based distance to static point (ROI center), see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance_roi`
       For CPU-based framewise Euclidean distance, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`
       For GPU CuPy solution for distance between two sets of points, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy`
       For GPU numba CUDA solution for distance between two sets of points, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`
...
def dunn_index(x: np.ndarray, y: np.ndarray) -> float:
    ...
    .. seelalso:
       For CPU-based method, use :func:`mufasa.mixins.statistics_mixin.Statistics.dunn_index`
...
def adjusted_rand_gpu(x: np.ndarray, y: np.ndarray) -> float:
    ...
    .. seealso::
       For CPU call, see :func:`mufasa.mixins.statistics_mixin.Statistics.adjusted_rand`.
...
def davis_bouldin(x: np.ndarray,
    ...
    .. seealso::
       For CPU implementation, use :func:`mufasa.mixins.statistics_mixin.Statistics.davis_bouldin`
...
def xie_beni(x: np.ndarray, y: np.ndarray) -> float:
    ...
    .. seealso::
       To compute Xie-Beni on the CPU, use :func:`~mufasa.mixins.statistics_mixin.Statistics.xie_beni`
...
def i_index(x: np.ndarray, y: np.ndarray, verbose: bool = False) -> float:
    ...
    .. seealso::
       To compute Xie-Beni on the CPU, use :func:`~mufasa.mixins.statistics_mixin.Statistics.i_index`
...
def kullback_leibler_divergence_gpu(x: np.ndarray,
    ...
    .. seealso::
       For CPU implementation, see :func:`mufasa.mixins.statistics_mixin.Statistics.kullback_leibler_divergence`.
...
def _hamming_kernel(x, y, w, r):
    """
    Hamming distance kernal called by :func:`mufasa.data_processors.cuda.statistics.hamming_distance_gpu`
    """
    idx = cuda.grid(1)
...
def hamming_distance_gpu(x: np.ndarray,
    ...
    .. seealso::
       For jitted CPU method, see :func:`mufasa.mixins.statistics_mixin.Statistics.hamming_distance`.
...
def sokal_sneath_gpu(x: np.ndarray, y: np.ndarray, w: Optional[np.ndarray] = None) -> float:
    ...
    .. seealso::
       For CPU method, see :func:`mufasa.mixins.statistics_mixin.Statistics.sokal_sneath`

...
def direction_from_two_bps(x: np.ndarray, y: np.ndarray) -> np.ndarray:
    ...
    .. seealso::
       For CPU function see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_two_bps`.
...
def sliding_circular_hotspots(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_hotspots`.
...
def sliding_circular_mean(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_mean`.
...
def sliding_circular_range(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_range`.
...
def sliding_circular_std(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_std`.
...
def sliding_rayleigh_z(x: np.ndarray,
    ...
    **Rayleigh Z-statistic:**
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_rayleigh_z`.
...
def sliding_resultant_vector_length(x: np.ndarray,
    ...
    .. seealso::
       For CPU function see :func:`~mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_resultant_vector_length`.
...
def direction_from_three_bps(x: np.ndarray,
    ...
    .. seealso::
       * More CPU function, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_three_bps`
...
def instantaneous_angular_velocity(x: np.ndarray, stride: Optional[int] = 1) -> np.ndarray:
    ...
    .. seealso::
       For CPU function, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.instantaneous_angular_velocity`
...
def sliding_bearing(x: np.ndarray,
    ...
    .. seealso::
       :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_bearing`
...
def sliding_angular_diff(x: np.ndarray,
    ...
    .. seealso::
       * For CPU function, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_angular_diff`
...
def rotational_direction(data: np.ndarray, stride: Optional[int] = 1) -> np.ndarray:
    ...
    * `2` where the angle has decreased in the negative direction.
    ...
    .. seealso::
       :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.rotational_direction` for jitted CPU method.

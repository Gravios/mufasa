...
def sliding_spatial_density_cuda(x: np.ndarray,
    ...
    .. seealso::
       :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.spatial_density`, :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_spatial_density`
...
def sliding_linearity_index_cuda(x: np.ndarray,
    ...
    .. seealso::
       :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_linearity_index`, :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.linearity_index`
...
def sliding_hjort_parameters_gpu(data: np.ndarray, window_sizes: np.ndarray, sample_rate: int) -> np.ndarray:
    ...
    .. seealso::
       For CPU implementation, see :`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.hjort_parameters`

...
from mufasa.bounding_box_tools.agg_boundary_stats import \
    AggBoundaryStatisticsCalculator
from mufasa.bounding_box_tools.boundary_statistics import \
    BoundaryStatisticsCalculator
from mufasa.bounding_box_tools.find_boundaries import AnimalBoundaryFinder
from mufasa.bounding_box_tools.visualize_boundaries import BoundaryVisualizer
...
from mufasa.utils.errors import NoChoosenMeasurementError, NoFilesFoundError
...
class BoundaryMenus(ConfigReader, PopUpMixin):
    ...
    Notes
    ----------
    `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/anchored_rois.md>`_.

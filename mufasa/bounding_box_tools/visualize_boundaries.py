...
class BoundaryVisualizer(ConfigReader, PlottingMixin):
    ...
    :parameter bool show_intersections:  If True, then produce highlight boundaries/keypoints to signify present intersections.
                                         See `this example for highlighted intersections <https://github.com/sgoldenlab/mufasa/blob/master/images/termites_video_3.gif>`_

    .. note::
        `Bounding boxes tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/anchored_rois.md>`_.

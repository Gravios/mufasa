...
class SLEAPImporterCSV(ConfigReader, PoseImporterMixin):
    ...
    .. note::
      ...
      `Example expected SLEAP csv data file for 5 animals / 4 pose-estimated body-parts  <https://github.com/sgoldenlab/mufasa/blob/master/misc/sleap_csv_example.csv>`__.
    ...
    def __init__(self,
                 ...
                 smoothing_settings: dict[str, int | str] | None = None):

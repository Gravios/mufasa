...
class SimBABlobImporter(ConfigReader):
    ...
    .. seealso::
       To generate blob tracking data, see :func:`mufasa.video_processors.blob_tracking_executor.BlobTrackingExecutor`.
       To visualize blob tracking results, see :func:`mufasa.plotting.blob_visualizer.BlobVisualizer`.

...
from mufasa.utils.read_write import (find_all_videos_in_project,
...
class SLEAPImporterSLP(ConfigReader, PoseImporterMixin):
    ...
    .. note::
      ...
      :meth:`mufasa.pose_importers.sleap_h5_importer.SLEAPImporterH5` or :meth:`mufasa.pose_importers.sleap_csv_importer.SLEAPImporterCSV`
...
# test = SLEAPImporterSLP(project_path="/Users/simon/Desktop/envs/mufasa/troubleshooting/sleap_two_animals/project_folder/project_config.ini",
#                         data_folder=r'/Users/simon/Desktop/envs/mufasa/troubleshooting/sleap_two_animals/slp_import',
#                         id_lst=['Simon', 'JJ'],

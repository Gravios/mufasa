...
class SimBAYoloImporter(ConfigReader):
    ...
    .. seealso::
       YOLO pose data can be created with :func:`mufasa.model.yolo_pose_inference.YOLOPoseInference` or :func:`mufasa.model.yolo_pose_track_inference.YOLOPoseTrackInference`.

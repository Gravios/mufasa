...
from mufasa.mixins.unsupervised_mixin import UMLMixin
from mufasa.unsupervised.enums import Unsupervised
...
from mufasa.utils.read_write import (drop_df_fields, read_pickle, write_df,
                                    write_pickle)
...
class UmapEmbedder(UMLMixin):
    ...
    :param data_path: Path holding pickled data-set created by `mufasa.unsupervised.dataset_creator.DatasetCreator.
    ...
    def transform(
        ...
        """
        :Example I: Transform.
        >>> data_path = '/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/logs/unsupervised_data_20240215143716.pickle'
        >>> model_path = '/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/clustering1704/academic_montalcini.pickle'
...
# #embedder.transform(save_dir=None, data_path=data_path, model=model_path, settings=None)
#
# embedder.transform(save_dir='/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/new_viz', data_path=data_path, model=model_path, settings={'DATA_FORMAT': 'scaled', 'CLASSIFICATIONS': True})
...
# data_path = '/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/logs/unsupervised_data_20240214093117.pickle'
# save_dir = '/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/dim_reduction_mdls'

...
from mufasa.unsupervised.enums import Clustering, Unsupervised
from mufasa.unsupervised.umap_embedder import UmapEmbedder
...
from mufasa.utils.read_write import drop_df_fields, read_pickle, write_pickle
...
class HDBSCANClusterer(UMLMixin):
    ...
    def transform(
        ...
        :Example I: Transform:
        >>> data_path = '/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/logs/unsupervised_data_20240218134920.pickle'
        >>> mdl_path = '/Users/simon/Desktop/envs/mufasa/troubleshooting/NG_Unsupervised/project_folder/cluster_mdls/hopeful_khorana.pickle'

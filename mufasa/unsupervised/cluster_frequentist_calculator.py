...
from mufasa.utils.read_write import get_unique_values_in_iterable, read_pickle
...
class ClusterFrequentistCalculator(UMLMixin, ConfigReader):
    ...
    :param Union[str, os.PathLike] data_path: path to pickle holding unsupervised results in ``mufasa.unsupervised.data_map.yaml`` format.

...
class ROITimebinCalculator(ConfigReader):
    ...
    .. important::
       Legacy. Use :func:`mufasa.roi_tools.roi_time_bins_analyzer.ROITimebinAnalyzer`.

    .. note::
       `Example anticipated ROI time-bins entry results <https://github.com/sgoldenlab/mufasa/blob/master/misc/ROI_time_bins_5.2s_entry_data_20240331125343.csv>`__.
       `Example anticipated ROI time-bins latency results <https://github.com/sgoldenlab/mufasa/blob/master/misc/ROI_time_bins_5.2s_time_data_20240331125343.csv>`__.
    ...
    :example:
    >>> calculator = ROITimebinCalculator(config_path=r"/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini", bin_length=1.0, body_parts=['Nose_1'], threshold=0.00, movement=True)
    >>> calculator.run()
    >>> calculator.save()
    """

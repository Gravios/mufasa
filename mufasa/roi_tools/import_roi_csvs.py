...
from mufasa.utils.warnings import MissingFileWarning, NoFileFoundWarning
...
class ROIDefinitionsCSVImporter(ConfigReader):
    ...
    .. note::
       ROI CSV files can be created from existing SimBA H5 ROI definitions using :func:`mufasa.utils.data.convert_roi_definitions`.

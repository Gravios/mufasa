...
from mufasa.utils.errors import NoROIDataError, ParametersFileError
...
class ROISizeStandardizer(ConfigReader, FeatureExtractionMixin):
    ...
    :example:
    >>> test = ROISizeStandardizer(config_path='/Users/simon/Desktop/envs/troubleshooting/DLC_2_Black_animals/project.toml', reference_video='Together_1')
    >>> test.run()
    >>> test.save()
    """

...
class InteractiveROIModifier():
    ...
    .. seealso::
       For an OpenCV-based version, see :class:`mufasa.roi_tools.interactive_modifier_ui.InteractiveROIModifier`.
       For creating new ROIs from scratch, see :func:`mufasa.roi_tools.roi_selector_polygon_tkinter.ROISelectorPolygonTkinter`
       and :func:`mufasa.roi_tools.roi_selector_circle_tkinter.ROISelectorCircleTkinter`.
    ...
    >>> import cv2
    >>> import numpy as np
    >>> from mufasa.roi_tools.interactive_roi_modifier_tkinter import InteractiveROIModifier

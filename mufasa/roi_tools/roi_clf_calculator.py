...
class ROIClfCalculator(ConfigReader):
    ...
    .. seealso::
       For multicore CPU process, see :func:`mufasa.roi_tools.roi_clf_calculator_mp.ROIClfCalculatorMultiprocess`
    ...
    :example:
    >>> analyzer = ROIClfCalculator(config_path=r"D:\troubleshooting\mitra\project_folder\project.toml", bp_names=('nose',), clf_names=('straub_tail',))
    >>> analyzer.run()
    >>> analyzer.save()
    """
    ...
    def __init__(self,
                 ...
                 data_paths: list[str | os.PathLike] | None = None,
                 roi_coordinates_path: str | os.PathLike = None,

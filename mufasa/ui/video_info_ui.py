...
from mufasa.utils.enums import (ConfigKey, Dtypes, Formats, Keys, Links,
                               Options, TagNames)
from mufasa.utils.errors import InvalidInputError, PermissionError
...
class VideoInfoTable(ConfigReader, PopUpMixin):
    ...
    ..seealso::
       `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario1.md#step-3-set-video-parameters>`__.

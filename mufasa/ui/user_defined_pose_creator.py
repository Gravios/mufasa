...
from mufasa.utils.enums import Paths, TextOptions
...
class PoseConfigCreator(PlottingMixin):
    ...
    ..seealso::
       `GitHub tutorial/documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/Pose_config.md>`__.
    ...
    :examples:
    >>> pose_config_creator = PoseConfigCreator(pose_name="My_test_config", no_animals=2, img_path='mufasa/splash_050122.png', bp_list=['Ear', 'Nose', 'Left_ear', 'Ear', 'Nose', 'Left_ear'], animal_id_int_list= [1, 1, 1, 2, 2, 2])

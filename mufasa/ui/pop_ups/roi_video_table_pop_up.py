...
from mufasa.ui.pop_ups.duplicate_rois_by_source_target_popup import \
    DuplicateROIsBySourceTarget
from mufasa.ui.pop_ups.import_roi_csv_popup import \
    ROIDefinitionsCSVImporterPopUp
from mufasa.ui.pop_ups.min_max_draw_size_popup import SetMinMaxDrawWindowSize
from mufasa.ui.pop_ups.roi_size_standardizer_popup import \
...
class ROITableRow():
    ...
    """
    Helper to create a single row class in the :func:`mufasa.ui.pop_ups.roi_video_table_pop_up.ROIVideoTable` table class.
    """
    def __init__(self,
                 config_path: Union[str, os.PathLike],

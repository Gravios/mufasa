...
from mufasa.utils.read_write import find_core_cnt, read_config_entry
...
class RunMachineModelsPopUp(PopUpMixin, ConfigReader):
    ...
    """
    :example:
    >>> _ = RunMachineModelsPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')

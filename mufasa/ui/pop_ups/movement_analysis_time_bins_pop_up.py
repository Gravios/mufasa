...
from mufasa.data_processors.timebins_movement_calculator_mp import \
...
class MovementAnalysisTimeBinsPopUp(ConfigReader, PopUpMixin):
    ...
    :example:
    >>> _ =  MovementAnalysisTimeBinsPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')

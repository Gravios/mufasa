...
from mufasa.labelling.extract_labelling_meta import AnnotationMetaDataExtractor
...
class ClfAnnotationCountPopUp(PopUpMixin, ConfigReader):
    """
    :example:
    >>> ClfAnnotationCountPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')
    """

...
from mufasa.utils.read_write import get_fn_ext, read_video_info
...
class QuickLineplotPopup(PopUpMixin, ConfigReader):
    def __init__(self,
        ...
        """
        :example:
        >>> _ = QuickLineplotPopup(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')
        """

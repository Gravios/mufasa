...
from mufasa.utils.enums import ConfigKey, Formats, Keys, Links
...
class ROIAnalysisPopUp(ConfigReader, PopUpMixin):
    ...
    """
    :example:
    >>> _ = ROIAnalysisPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')
    """

...
class AppendROIFeaturesByBodyPartPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: Union[str, os.PathLike]):
        ...
        if not os.path.isfile(self.roi_coordinates_path):
            raise NoROIDataError(msg="No ROIs have been defined. Please define ROIs before appending ROI-based features",source=self.__class__.__name__,)
...
# _ = AppendROIFeaturesByBodyPartPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/open_field_below/project_folder/project_config.ini')

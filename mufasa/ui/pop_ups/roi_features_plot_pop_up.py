...
from mufasa.utils.read_write import find_all_videos_in_directory, str_2_bool
...
class VisualizeROIFeaturesPopUp(PopUpMixin, ConfigReader, FeatureExtractionMixin):
    ...
    """
    :example:
    >>> _ = VisualizeROIFeaturesPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/mouse_open_field/project_folder/project_config.ini')
    """
    def __init__(self,
...
#_ = VisualizeROIFeaturesPopUp(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/mitra/project_folder/project_config.ini')

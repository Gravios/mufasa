...
#from mufasa.ui.create_project_ui.ProjectCreatorPopUp
from mufasa.ui.tkinter_functions import (CreateLabelFrameWithIcon, Entry_Box,
                                        FileSelect, SimbaButton, SimBALabel)
from mufasa.ui.user_defined_pose_creator import PoseConfigCreator
...
class CreateUserDefinedPoseConfigurationPopUp(PopUpMixin):
    def __init__(self,
                 ...
                 project_config_class = None): # mufasa.ui.create_project_ui.ProjectCreatorPopUp

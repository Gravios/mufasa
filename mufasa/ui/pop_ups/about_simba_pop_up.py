...
from mufasa.utils.enums import OS, Formats, Links, Paths
from mufasa.utils.lookups import rgb_to_hex
from mufasa.utils.read_write import get_video_meta_data

LINKS = [
         ("GitHub", "https://github.com/sgoldenlab/mufasa", "github_2"),
         ("API", "https://mufasa-uw-tf-dev.readthedocs.io/en/latest/api.html", "documentation_large"),
         ...
         ("PyPI", "https://pypi.org/project/mufasa-uw-tf-dev/", "rocket")
         ]
...
class AboutSimBAPopUp:
    def __init__(self,
        ...
        self.root = Toplevel()
        icon_path = os.path.join(os.path.dirname(mufasa.__file__), "assets", "icons", "SimBA_logo_3_small.png")
        try:

...
from mufasa.utils.enums import Defaults, FontPaths, Paths
...
class SplashMovie:
    def __init__(self,
        ...
        splash_path = os.path.join(os.path.dirname(mufasa.__file__), Paths.SPLASH_PATH_MOVIE.value)
        ...
        if font_path is not None:
            self.font_path = os.path.join(os.path.dirname(mufasa.__file__), font_path)

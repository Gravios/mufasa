...
from mufasa.ui.tkinter_functions import (CreateLabelFrameWithIcon, Entry_Box,
                                        SimbaButton)
from mufasa.utils.checks import (check_if_valid_img, check_instance, check_int,
                                check_str, check_valid_tuple)
from mufasa.utils.enums import Formats
from mufasa.utils.errors import FrameRangeError, InvalidVideoFileError
...
from mufasa.video_processors.video_processing import create_average_frm

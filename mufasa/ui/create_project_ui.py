...
from mufasa.ui.ml_settings_frm import GetMLSettingsFrame
from mufasa.ui.pop_ups.clf_add_remove_print_pop_up import PoseResetterPopUp
from mufasa.ui.pop_ups.create_user_defined_pose_configuration_pop_up import \
...
from mufasa.utils.checks import check_if_dir_exists, check_str
from mufasa.utils.config_creator import ProjectConfigCreator
from mufasa.utils.enums import Formats, Keys, Links, Methods, Options, Paths
from mufasa.utils.errors import DuplicationError, MissingProjectConfigEntryError
from mufasa.utils.lookups import (get_body_part_configurations,
...
class ProjectCreatorPopUp():
    ...
    def __init__(self):
        ...
        project_animal_cnt_path = os.path.join(os.path.dirname(mufasa.__file__), Paths.SIMBA_NO_ANIMALS_PATH.value)

...
from mufasa.utils.enums import ROI_SETTINGS, TextOptions
...
class GetPixelsPerMillimeterInterface():
    ...
    :example:
    >>> runner = GetPixelsPerMillimeterInterface(video_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/videos/Together_1.avi', known_metric_mm=140)
    >>> runner.run()

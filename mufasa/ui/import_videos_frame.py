...
from mufasa.utils.read_write import (copy_multiple_videos_to_project,
                                    copy_single_video_to_project)

#from mufasa.sandbox.tkinter_drag_and_drop import FileDropBox
...
class ImportVideosFrame(PopUpMixin, ConfigReader):
    ...
    :example:
    >>> ImportVideosFrame(config_path='/Users/simon/Desktop/envs/mufasa/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini')
    """

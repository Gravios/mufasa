...
from mufasa.utils.errors import FrameRangeError, NoDataError, NoFilesFoundError
...
class LabellingInterface(ConfigReader):
    ...
    .. note::
       Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/label_behavior.md>`__.

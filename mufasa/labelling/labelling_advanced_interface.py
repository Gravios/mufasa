...
from mufasa.utils.errors import (AdvancedLabellingError, FrameRangeError,
                                NoDataError)
from mufasa.utils.lookups import (get_labelling_img_kbd_bindings,
...
class AdvancedLabellingInterface(ConfigReader):
    ...
    .. note::
       `Advanced annotation tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/advanced_labelling.md>`__.
    ...
    def __init__(self, config_path: str, file_path: str, continuing: bool):
        ...
        self.play_video_script_path = os.path.join(os.path.dirname(mufasa.__file__), "labelling", "play_annotation_video.py")

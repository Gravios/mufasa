...
from mufasa.utils.read_write import (find_closest_readable_frame,
...
class LabellingInterface(ConfigReader):
    ...
    .. note::
       See the `tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/label_behavior.md>`__.
            ...
            try:
                ...
                raise NoFilesFoundError(
                    msg=(
                        ...
                        f'Mufasa expects features for video '

...
def jitted_hull(points: np.ndarray, target: str = "perimeter") -> np.ndarray:
    ...
    .. seealso::
       :func:`mufasa.feature_extractors.perimeter_jit.get_hull_sizes` (wrapper with validation).
    """

...
class ExtractFeaturesFrom16bps(ConfigReader, FeatureExtractionMixin):
    ...
    .. note::
       `Feature extraction tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial.md#step-5-extract-features>`__.
       `Expected pose configuration <https://github.com/sgoldenlab/mufasa/blob/master/mufasa/pose_configurations/schematics/7.png>`_

...
class FFMPEGCommandCreator(object):
    ...
    ----------
    json_path: str
        path to json file storing FFmpeg instructions as created by ``mufasa.batch_process_vides.BatchProcessFrame``.

    Notes
    ----------
    `Batch pre-process tutorials <https://github.com/sgoldenlab/mufasa/blob/master/docs/tutorial_process_videos.md>`__.
    `Example expected JSON file <https://github.com/sgoldenlab/mufasa/blob/master/misc/batch_process_log.json>`__.

...
class ROISelectorPolygon(object):
    ...
    :example:
    >>> polygon_selector = ROISelectorPolygon(path='/path/to/amber.png')
    >>> polygon_selector.run()
    >>> polygon_selector = ROISelectorPolygon(path='/path/to/Box2_IF19_7_20211109T173625_4_851_873_1_cropped.mp4')
    >>> polygon_selector.run()
    """

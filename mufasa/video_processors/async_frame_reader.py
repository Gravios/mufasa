...
class AsyncVideoFrameReader:
    ...
    .. note::
       Wrapper of :func:`~mufasa.utils.read_write.read_img_batch_from_video_gpu` or :func:`~mufasa.utils.read_write.read_img_batch_from_video` which allows parallel decoding of video frames.

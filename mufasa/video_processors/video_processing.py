...
def convert_to_jpeg(path: Union[str, os.PathLike, List[Union[str, os.PathLike]]],
    ...
    .. seealso::
       For BMP images, see :func:`~mufasa.video_processors.video_processing.convert_to_bmp`. For PNG, see :func:`~mufasa.video_processors.video_processing.convert_to_png`.
       For TIFF, see :func:`~mufasa.video_processors.video_processing.convert_to_tiff`. For WEBP, see :func:`~mufasa.video_processors.video_processing.convert_to_webp`.
...
def convert_to_bmp(path: Union[str, os.PathLike, List[Union[str, os.PathLike]]],
    ...
    .. seealso::
       For JEPG, see :func:`~mufasa.video_processors.video_processing.convert_to_jpeg`. For PNG, see :func:`~mufasa.video_processors.video_processing.convert_to_png`.
       For TIFF, see :func:`~mufasa.video_processors.video_processing.convert_to_tiff`. For WEBP, see :func:`~mufasa.video_processors.video_processing.convert_to_webp`.
...
def convert_to_png(path: Union[str, os.PathLike],
    ...
    .. seealso::
       For BMP images, see :func:`~mufasa.video_processors.video_processing.convert_to_bmp`. For JEPG, see :func:`~mufasa.video_processors.video_processing.convert_to_jpeg`.
       For TIFF, see :func:`~mufasa.video_processors.video_processing.convert_to_tiff`. For WEBP, see :func:`~mufasa.video_processors.video_processing.convert_to_webp`.
...
def convert_to_tiff(directory: Union[str, os.PathLike],
    ...
    Convert images in a directory to TIFF format.
     ...
     .. seealso::
       For BMP images, see :func:`~mufasa.video_processors.video_processing.convert_to_bmp`. For JEPG, see :func:`~mufasa.video_processors.video_processing.convert_to_jpeg`.
       For PNG, see :func:`~mufasa.video_processors.video_processing.convert_to_png`. For WEBP, see :func:`~mufasa.video_processors.video_processing.convert_to_webp`.
...
def convert_to_webp(path: Union[str, os.PathLike],
    ...
    .. seealso::
       For BMP images, see :func:`~mufasa.video_processors.video_processing.convert_to_bmp`. For JEPG, see :func:`~mufasa.video_processors.video_processing.convert_to_jpeg`.
       For PNG, see :func:`~mufasa.video_processors.video_processing.convert_to_png`. For TIFF, see :func:`~mufasa.video_processors.video_processing.convert_to_tiff`.
...
def clahe_enhance_video(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For multicore method, see :func:`mufasa.video_processors.video_processing.clahe_enhance_video_mp`.
...
def clahe_enhance_video_mp(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For single core method, see :func:`mufasa.video_processors.video_processing.clahe_enhance_video`.
...
def change_single_video_fps(file_path: Union[str, os.PathLike],
    ...
    .. note::
       To change the FPS of all videos in a directory, use ``mufasa.video_processors.video_processing.change_fps_of_multiple_videos``.
...
def video_to_greyscale(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For GPU CuPY acceleration, see :func:`~mufasa.data_processors.cuda.image.img_stack_to_grayscale_cupy`
       For GPU numba \ CUDA acceleration, see :func:`~mufasa.data_processors.cuda.image.img_stack_to_grayscale_cuda`,
       For multicore CPU solutions, see :func:`~mufasa.mixins.image_mixin.ImageMixin.img_stack_to_greyscale` or :func:`~mufasa.video_processors.video_processing.batch_video_to_greyscale`
       For single-core multivideo solution, see :func:`~mufasa.video_processors.video_processing.batch_video_to_greyscale`
...
def batch_video_to_greyscale(path: Union[str, os.PathLike, List[Union[str, os.PathLike]]],
    ...
    .. seealso::
       ...
       For GPU numba\ CUDA acceleration, see :func:`~mufasa.data_processors.cuda.image.img_stack_to_grayscale_cuda`,
       For multicore CPU solutions, see :func:`~mufasa.mixins.image_mixin.ImageMixin.img_stack_to_greyscale` or :func:`~mufasa.video_processors.video_processing.batch_video_to_greyscale`
       For single-core single video solution, see :func:`~mufasa.video_processors.video_processing.video_to_greyscale`
...
def remove_beginning_of_video(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       To remove N seconds from the end of the video, see :func:`mufasa.video_processors.video_processing.remove_end_of_video`.
...
def remove_end_of_video(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       To remove N seconds from the beginning of the video, see :func:`mufasa.video_processors.video_processing.remove_beginning_of_video`
...
def gif_creator(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       ...
       consider ``webm`` format which are for online publication and ``mufasa.video_processors.video_processing.convert_to_webm``.
...
def crop_single_video(file_path: Union[str, os.PathLike],
    ...
    .. seealso::
       To crop multiple videos, see :func:`~mufasa.video_processors.video_processing.crop_multiple_videos`
...
def crop_multiple_videos(directory_path: Union[str, os.PathLike],
    ...
    .. seealso::
       To crop one video, see :func:`mufasa.video_processors.video_processing.crop_single_video`

    .. note::
       Calls the :func:`~mufasa.video_processors.roi_selector.ROISelector` interface.
...
def crop_single_video_circle(file_path: Union[str, os.PathLike]) -> None:
    ...
    # [Linux-only] Darwin spawn guard removed — default fork is used.
...
def crop_multiple_videos_circles(in_dir: Union[str, os.PathLike], out_dir: Union[str, os.PathLike]) -> None:
    ...
    .. seealso::
       :func:`mufasa.video_processors.video_processing.crop_single_video_circle`
...
def horizontal_video_concatenator(video_paths: List[Union[str, os.PathLike]],
    ...
    .. seealso::
       :func:`mufasa.video_processors.video_processing.vertical_video_concatenator`
...
def vertical_video_concatenator(video_paths: List[Union[str, os.PathLike]],
    ...
    .. seealso::
       :func:`mufasa.video_processors.video_processing.horizontal_video_concatenator`
...
def superimpose_video_progressbar(video_path: Union[str, os.PathLike],
    ...
    :param Optional[str] color: The color of the progress bar. See mufasa.utils.lookups.get_color_dict keys for accepted names.
...
def crossfade_two_videos(video_path_1: Union[str, os.PathLike],
    ...
    .. note::
       See ``mufasa.utils.lookups.get_ffmpeg_crossfade_methods`` for named crossfade methods.
    ...
    :param Optional[str] crossfade_method: The crossfade method. For accepted methods, see ``mufasa.utils.lookups.get_ffmpeg_crossfade_methods``.
...
def video_to_bw(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       :func:`mufasa.mixins.image_mixin.ImageMixin.img_to_bw`, :func:`mufasa.mixins.image_mixin.ImageMixin.img_stack_to_bw`,
       :func:`mufasa.data_processors.cuda.image.img_stack_to_bw`
...
def create_average_frm(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       See :func:`mufasa.data_processors.cuda.image.create_average_frm_cupy`, :func:`mufasa.data_processors.cuda.image.create_average_frm_cuda` for GPU acceleration.
    ...
    .. note::
       Useful helper for e.g., video background subtraction ``mufasa.video_processors.video_processing.video_bg_substraction()``
...
def video_bg_subtraction(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       For multicore CPU alternative, see :func:`~mufasa.video_processors.video_processing.video_bg_substraction_mp.
       For GPU based alternative, see :func:`mufasa.data_processors.cuda.image.bg_subtraction_cuda` or :func:`mufasa.data_processors.cuda.image.bg_subtraction_cupy`.
...
def video_bg_subtraction_mp(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
        For single core alternative, see :func:`~mufasa.video_processors.video_processing.video_bg_subtraction`.
        For GPU based alternative, see :func:`~mufasa.data_processors.cuda.image.bg_subtraction_cuda` or :func:`~mufasa.data_processors.cuda.image.bg_subtraction_cupy`.
...
def get_video_slic(video_path: Union[str, os.PathLike],
    ...
    .. seealso::
       To convert single image, see :func:`mufasa.video_processors.video_processing.get_img_slic`
...
def change_playback_speed_dir(data_dir: Union[str, os.PathLike],
    ...
    .. seealso::
       For processing a single video file, see :func:`~mufasa.video_processors.video_processing.change_playback_speed`.

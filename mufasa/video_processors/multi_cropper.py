...
class MultiCropper(object):
    ...
    .. note::
       `Multi-crop tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Tutorial_tools.md#multi-crop-videos>`__.

       `Expected GPU timesavings <https://github.com/sgoldenlab/mufasa/blob/master/docs/gpu_vs_cpu_video_processing_runtimes.md>`__.

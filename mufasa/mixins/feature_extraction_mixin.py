...
class FeatureExtractionMixin(object):
    ...
    def euclidean_distance(bp_1_x: np.ndarray,
        ...
        .. seealso::
            For improved runtime on CPU, use :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance` or :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.keypoint_distances`.
            For GPU acceleration through CuPy, use :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy`.
            For GPU acceleration through numba CUDA, use :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`.
    ...
    def angle3pt(ax: float, ay: float, bx: float, by: float, cx: float, cy: float) -> float:
        ...
        .. seealso::
           For multicore numba based method across multiple observations, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt_vectorized`.
           For GPU acceleration, use :func:`mufasa.data_processors.cuda.statistics.get_3pt_angle`.
    ...
    def angle3pt_vectorized(data: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For GPU acceleration, use :func:`mufasa.data_processors.cuda.statistics.get_3pt_angle` for single frame alternative,
           see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt`
    ...
    def convex_hull_calculator_mp(arr: np.ndarray, px_per_mm: float) -> float:
        ...
        .. seealso::
           For numba CPU based acceleration, use :func:`mufasa.feature_extractors.perimeter_jit.jitted_hull`.
           For multicore based acceleration, use :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bodyparts_to_polygon`.
           For numba CUDA based acceleration, use :func:`mufasa.data_processors.cuda.geometry.get_convex_hull`,
    ...
    def three_point_angle(bp_1: Union[np.ndarray, pd.DataFrame],
        ...
        .. note::
           ...
           before calling :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt_vectorized`.

        .. seealso::
           For scalar (single-frame) angle computation, use :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt`.
           For the numba-accelerated vectorized implementation used internally, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.angle3pt_vectorized`.
    ...
    def count_values_in_range(data: np.ndarray, ranges: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For GPU acceleration, use :func:`mufasa.data_processors.cuda.statistics.count_values_in_ranges`
    ...
    def framewise_euclidean_distance_roi(location_1: np.ndarray,
        ...
        .. seealso::
           For distances between two moving targets, use :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`,
           For GPU implementation, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy` or :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`
           For numpy method (which appears faster than numba) use :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.keypoint_distances`.
    ...
    def framewise_inside_rectangle_roi(bp_location: np.ndarray, roi_coords: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For GPU acceleration, use :func:`mufasa.data_processors.cuda.geometry.is_inside_rectangle`.
    ...
    def is_inside_circle(bp: np.ndarray, roi_center: np.ndarray, roi_radius: int) -> np.ndarray:
        ...
        .. seealso::
           For GPU acceleration, see :func:`mufasa.data_processors.cuda.geometry.is_inside_circle`
    ...
    def framewise_inside_polygon_roi(bp_location: np.ndarray, roi_coords: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For GPU acceleration, use :func:`mufasa.data_processors.cuda.geometry.is_inside_polygon`
    ...
    def windowed_frequentist_distribution_tests(data: np.ndarray, feature_name: str, fps: int) -> pd.DataFrame:
        ...
        .. warning::
           This is a **legacy** method. For KS test, use :func:`mufasa.mixins.statistics_mixin.Statistics.two_sample_ks`.
           For t-tests, use :func:`mufasa.mixins.statistics_mixin.Statistics.independent_samples_t.
           For Shapiro-Wilks, use :func:`mufasa.mixins.statistics_mixin.Statistics.rolling_shapiro_wilks`.
           For peaks, use :func:`mufasa.mixins.feature_extraction_supplement_mixin.FeatureExtractionSupplemental.peak_ratio`.
    ...
    def create_shifted_df(df: pd.DataFrame, periods: int = 1, suffix: str = "_shifted") -> pd.DataFrame:
        ...
        .. seealso::
           For NumPy input and shifted-values-only output, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.create_shifted_array`.
    ...
    def create_shifted_array(data: np.ndarray, periods: int = 1) -> np.ndarray:
        ...
        .. seealso::
           For pandas DataFrame input with concatenated original and shifted columns, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.create_shifted_df`.
    ...
    def jitted_line_crosses_to_nonstatic_targets(left_ear_array: np.ndarray,
        ...
        .. seealso::
           Input left ear, right ear, and nose coordinates of the observer is returned by :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.check_directionality_viable`

           If the target is static, consider :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.jitted_line_crosses_to_static_targets`
    ...
    def jitted_line_crosses_to_static_targets(left_ear_array: np.ndarray,
        ...
        .. note::
           ...
           If the target is moving, consider :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.jitted_line_crosses_to_nonstatic_targets`.

        .. seealso::
           For GPU accelerated methods, see :func:`mufasa.data_processors.cuda.geometry.directionality_to_static_targets`
    ...
    def minimum_bounding_rectangle(points: np.ndarray) -> np.ndarray:
        ...
        .. note::
           ...
           See :func:`mufasa.mixins.feature_extractors.perimeter_jit.jitted_hull` for computing the convexhull vertices.

        .. seealso::
           For multicore method and improved runtimes, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_minimum_rotated_rectangle`
    ...
    def framewise_euclidean_distance(location_1: np.ndarray,
        ...
        .. seealso::
           For GPU CuPy solution, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy`.
           For GPU numba CUDA solution, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`.
           For Euclidean distance between one moving and one static target, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance_roi`.
           For wrapper function ensuring dtypes and data validity in this method, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.bodypart_distance`.
    ...
    def framewise_bodypart_movement(data: Union[np.ndarray, pd.DataFrame],
        ...
        .. seealso::
           For movement between two distinct body-parts, use func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.bodypart_distance`.
           For direct per-frame distance computation between two coordinate arrays, use func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`.
    ...
    def bodypart_distance(bp1_coords: np.ndarray,
        ...
        .. seealso::
           Wrapper function (ensuring data validity) for the underlying implementation :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`.
           For GPU CuPy solution, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy`.
           For GPU numba CUDA solution, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`.
           For Euclidean distance between one moving and one static target, see :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance_roi`.
    ...
    def keypoint_distances(a: np.ndarray,
        ...
        .. seealso::
           For numba decorated function, :func:`mufasa.mixins.feature_extraction_mixin.FeatureExtractionMixin.framewise_euclidean_distance`
           For GPU CuPy solution, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cupy`.
           For GPU numba CUDA solution, see :func:`mufasa.data_processors.cuda.statistics.get_euclidean_distance_cuda`.
    ...
    def line_crosses_to_static_targets(
        ...
        **Legacy** non-jitted helper to calculate if an animal is directing towards a static coordinate (e.g., ROI centroid).
        ...
        .. important:
           For improved runtime, use :func:`mufasa.mixins.feature_extraction_mixin.jitted_line_crosses_to_static_targets`
    ...
    def find_midpoints(bp_1: np.ndarray,
        ...
        .. seealso::
           For GPU acceleration, use :func:`mufasa.data_processors.cuda.geometry.find_midpoints`

...
class ImageMixin(object):
    ...
    pose-estimated points within ``mufasa.mixins.geometry_mixin.GeometryMixin`` methods.
    ...
    def brightness_intensity(imgs: Union[List[np.ndarray], np.ndarray], ignore_black: bool = True, verbose: bool = False) -> np.ndarray:
        ...
        .. seealso::
           For GPU acceleration, see :func:`mufasa.data_processors.cuda.image.img_stack_brightness`. For geometry based brightness, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.get_geometry_brightness_intensity`
    ...
    def get_histocomparison(
        ...
        .. seealso::
           For histogram comparison within specific geometries, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.geometry_histocomparison`.
    ...
    def slice_shapes_in_img(img: Union[np.ndarray, Tuple[cv2.VideoCapture, int]], geometries: List[Union[Polygon, np.ndarray]]) -> List[np.ndarray]:
        ...
        .. note::
           ...
           and shifting geometries across images, consider ``mufasa.mixins.image_mixin.ImageMixin.slice_shapes_in_imgs``
           which uses CPU multiprocessing.

        .. seealso::
           For GPU acceleration, see :func:`mufasa.data_processors.cuda.image.slice_imgs`
           For single core method, see :func:`mufasa.mixins.image_mixin.ImageMixin.slice_shapes_in_imgs`
    ...
    def find_contours(img: np.ndarray,
        ...
        .. seealso::
           For contour comparisons, see :func:`mufasa.mixins.image_mixin.ImageMixin.get_contourmatch`
    ...
    def img_to_bw(
        ...
        .. seealso::
           If converting multiple images from colour to black and white, consider :func:`mufasa.mixins.image_mixin.ImageMixin.img_stack_to_bw` for multi-core method or
           :func:`mufasa.data_processors.cuda.image.img_stack_to_bw` for GPU acceleration.
    ...
    def img_stack_to_bw(imgs: np.ndarray, lower_thresh: int, upper_thresh: int, invert: bool):
        ...
        .. note::
           If converting a single image, consider ``mufasa.mixins.image_mixin.ImageMixin.img_to_bw()``. For GPU acceleration,
           see :func:`mufasa.data_processors.cuda.image.img_stack_to_bw`.
    ...
    def segment_img_horizontal(
        ...
        .. seealso::
           :func:`mufasa.mixins.image_mixin.ImageMixin.segment_img_stack_horizontal`, :func:`mufasa.mixins.image_mixin.ImageMixin.segment_img_vertical`,
           :func:`mufasa.data_processors.cuda.image.segment_img_stack_horizontal`, :func:`mufasa.data_processors.cuda.image.segment_img_stack_vertical`
    ...
    def segment_img_stack_horizontal(imgs: np.ndarray, pct: int, lower: bool, both: bool) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.image_mixin.ImageMixin.segment_img_horizontal`
    ...
    def segment_img_vertical(
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.image.segment_img_stack_vertical`
           :func:`mufasa.data_processors.cuda.image.segment_img_stack_horizontal`
    ...
    def img_stack_mse(imgs_1: np.ndarray, imgs_2: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For time-series comparison and GPU acceleration, see :func:`mufasa.data_processors.cuda.image.stack_sliding_mse`.
           For time-series comparison and multicore acceleration, see:func:`mufasa.mixins.image_mixin.ImageMixin.img_sliding_mse`
    ...
    def img_sliding_mse(imgs: np.ndarray,
        ...
        .. seealso::
           For GPU acceleration, see :func:`mufasa.data_processors.cuda.image.stack_sliding_mse`.
           To compare images in two stacks, see :func:`mufasa.mixins.image_mixin.ImageMixin.img_stack_mse`
    ...
    def read_img_batch_from_video(video_path: Union[str, os.PathLike],
        ...
        .. seealso::
           For GPU acceleration, see :func:`mufasa.utils.read_write.read_img_batch_from_video_gpu`
    ...
    def img_matrix_mse(imgs: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For time-series and GPU acceleration, see :func:`mufasa.data_processors.cuda.image.stack_sliding_mse`.
           For time-series and multicore CPU solution, see :func:`mufasa.mixins.image_mixin.ImageMixin.img_sliding_mse`
           To compare two images, see :func:`mufasa.mixins.image_mixin.ImageMixin.img_stack_mse`
    ...
    def img_to_greyscale(img: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For CuPy based GPU acceleration, see :func:`mufasa.data_processors.cuda.image.img_stack_to_grayscale_cupy`
           For numba CUDA based GPU acceleration, see :func:`mufasa.data_processors.cuda.image.img_stack_to_grayscale_cuda`
           For numba based multicore solution, see :func:`mufasa.mixins.image_mixin.ImageMixin.img_stack_to_greyscale`
    ...
    def img_stack_to_greyscale(imgs: np.ndarray):
        ...
        .. seealso::
           For CuPy based GPU acceleration, see :func:`mufasa.data_processors.cuda.image.img_stack_to_grayscale_cupy`
           For numba CUDA based GPU acceleration, see :func:`mufasa.data_processors.cuda.image.img_stack_to_grayscale_cuda`
           For single image conversion, see :func:`mufasa.mixins.image_mixin.ImageMixin.img_to_greyscale`
    ...
    def pad_img_stack(image_dict: Dict[int, np.ndarray], pad_value: Optional[int] = 0) -> Dict[int, np.ndarray]:
        ...
        .. seealso::
           To read in a dictionary of images from a video using GPU acceleration, see :func:`mufasa.utils.read_write.read_img_batch_from_video_gpu`
           To read in a dictionary of images from a video using multicore acceleration, see :func:`mufasa.mixins.image_mixin.ImageMixin.read_img_batch_from_video`
           To read in a dictionary of images from a directory using multicore acceleration, use :func:`mufasa.mixins.image_mixin.ImageMixin.read_all_img_in_dir`
    ...
    def img_stack_to_video(imgs: Dict[int, np.ndarray],
        ...
        .. note::
           The input dictionary ``imgs`` can be created with ``mufasa.mixins.ImageMixin.slice_shapes_in_imgs``.

        .. seealso::
           For GPU acceleration, see :func:`mufasa.utils.read_write.img_stack_to_video`.
    ...
    def slice_shapes_in_imgs(self,
        ...
        .. seealso::
           For GPU acceleration, see :func:`mufasa.data_processors.cuda.image.slice_imgs`
           For single core process, use :func:`mufasa.mixins.image_mixin.ImageMixin.slice_shapes_in_img`
    ...
    def structural_similarity_index(img_1: np.ndarray, img_2: np.ndarray) -> float:
        ...
        .. seealso::
           For matrix SSI of image stack, see :func:`mufasa.mixins.image_mixin.ImageMixin.structural_similarity_matrix`
           for time-series based comparison, see :func:`mufasa.mixins.image_mixin.ImageMixin.sliding_structural_similarity_index`
    ...
    def sliding_structural_similarity_index(imgs: List[np.ndarray],
        ...
        .. seealso::
           For matrix SSI of image stack, see :func:`mufasa.mixins.image_mixin.ImageMixin.structural_similarity_matrix`
           For simple comparison of two images, see :func:`mufasa.mixins.image_mixin.ImageMixin.structural_similarity_index`
    ...
    def cross_correlation_similarity(img_1: np.ndarray, img_2: np.ndarray) -> float:
        ...
        .. seealso::
           For time-series based NCC comparisons, see :func:`mufasa.mixins.image_mixin.ImageMixin.sliding_cross_correlation_similarity`
           For matrix based NCC comparisons, see :func:`mufasa.mixins.image_mixin.ImageMixin.cross_correlation_matrix`
    ...
    def sliding_cross_correlation_similarity(imgs: np.ndarray,
        ...
        .. seealso::
           For simple two image NCC comparison, see :func:`mufasa.mixins.image_mixin.ImageMixin.cross_correlation_similarity`
           For matrix based NCC comparisons, see :func:`mufasa.mixins.image_mixin.ImageMixin.cross_correlation_matrix`
    ...
    def non_local_mean_denoising_sequence(imgs: np.ndarray,
        ...
        .. seealso::
           For single images, see :func:`~mufasa.mixins.image_mixin.ImageMixin.non_local_mean_denoising_image`

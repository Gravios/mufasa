...
class PlottingMixin:
    ...
    def create_gantt_img(self,
        ...
        :param pd.DataFrame bouts_df: ataframe holding information on individual bouts created by :meth:`mufasa.misc_tools.get_bouts_for_gantt`.
    ...
    def make_distance_plot(
        ...
        .. note::
           `GitHub tutorial/documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#visualizing-distance-plots>`__.
    ...
    def make_probability_plot(
        ...
        .. notes:
          `Tutorial <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario2.md#visualizing-classification-probabilities>`__.
    ...
    def make_line_plot_plotly(
        ...
        .. note::
           ...
           If **not** called though multiprocessing, consider using ``mufasa.mixins.plotting_mixin.PlottingMixin.make_line_plot()``
    ...
    def insert_directing_line(
        ...
        :param directing_df: Dataframe containing eye and ROI locations. Stored as ``results`` in  instance of ``mufasa.roi_tools.ROI_directing_analyzer.DirectingROIAnalyzer``.
    ...
    def get_optimal_font_scales(self,
        ...
        :param Optional[int] font: The font integer representation 0-7. See ``mufasa.utils.enums.Options.CV2_FONTS.values
    ...
    def plot_clf_cumcount(config_path: str | os.PathLike,
        ...
        :example:
        >>> plot_clf_cumcount(config_path=r"D:\troubleshooting\mitra\project_folder\project.toml", clf='CIRCLING', data_dir=r'D:\troubleshooting\mitra\project_folder\logs\test', seconds=True, bouts=True)
        """

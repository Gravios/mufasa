...
class ConfigReader(object):
    ...
    def find_animal_name_from_body_part_name(self, bp_name: str, bp_dict: dict) -> str:
        ...
        :param dict bp_dict: Nested dict holding animal names as keys and body-part names as and coordinates as values. Created by :meth:`mufasa.mixins.config_reader.ConfigReader.create_body_part_dictionary`
        :returns str
    ...
    def create_body_part_dictionary(
        ...
        :param List[str] x_cols: column names for body-part coordinates on x-axis. Returned by  :meth:`mufasa.mixins.config_reader.ConfigReader.get_body_part_names`
        :param List[str] y_cols: column names for body-part coordinates on y-axis. Returned by  :meth:`mufasa.mixins.config_reader.ConfigReader.get_body_part_names`
        :param List[str] p_cols: column names for body-part pose-estimation probability values. Returned by  :meth:`mufasa.mixins.config_reader.ConfigReader.get_body_part_names`
        :param Optional[List[List[Tuple[int, int, int]]]] colors: Optional bgr colors to associate with the body-parts. Returned by :meth:`mufasa.utils.data.create_color_palettes`.
        :returns dict

...
from mufasa.utils.enums import ENV_VARS
from mufasa.utils.read_write import read_sys_env
from mufasa.utils.warnings import VersionWarning

ENV = read_sys_env()

### IMPORT CURF IF SET BY mufasa/assets/.env

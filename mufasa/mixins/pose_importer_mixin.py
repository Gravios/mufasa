...
class PoseImporterMixin(object):
    ...
    def link_video_paths_to_data_paths(self,
        ...
        :param Optional[object] filename_cleaning_func: Optional filename cleaning function that the data_paths filenames would have to pass through in order to find a matching video name. E.g., ``mufasa.utils.read_write.clean_sleap_filename(filepath)``.

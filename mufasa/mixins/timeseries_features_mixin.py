...
class TimeseriesFeatureMixin(object):
    ...
    def sliding_hjort_parameters(data: np.ndarray, window_sizes: np.ndarray, sample_rate: int) -> np.ndarray:
        ...
        .. seealso::
           For single pass, see :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.hjort_parameters`
    ...
    def crossings(data: np.ndarray, val: float) -> int:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_crossings`
    ...
    def sliding_crossings(data: np.ndarray, val: float, time_windows: np.ndarray, fps: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.crossings`
    ...
    def percentile_difference(data: np.ndarray, upper_pct: int, lower_pct: int) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_percentile_difference`
    ...
    def sliding_percentile_difference(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.percentile_difference`
    ...
    def percent_beyond_n_std(data: np.ndarray, n: float) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_percent_beyond_n_std`
    ...
    def sliding_percent_beyond_n_std(data: np.ndarray, n: float, window_sizes: np.ndarray, sample_rate: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.percent_beyond_n_std`
    ...
    def percent_in_percentile_window(data: np.ndarray, upper_pct: int, lower_pct: int):
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_percent_in_percentile_window`
    ...
    def sliding_percent_in_percentile_window(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.percent_in_percentile_window`
    ...
    def petrosian_fractal_dimension(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_petrosian_fractal_dimension`
    ...
    def sliding_petrosian_fractal_dimension(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.petrosian_fractal_dimension`
    ...
    def line_length(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_line_length`
    ...
    def sliding_line_length(data: np.ndarray, window_sizes: np.ndarray, sample_rate: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.line_length`
    ...
    def sliding_window_stats(data: np.ndarray, window_sizes: Union[List, np.ndarray], sample_rate: float,
        ...
        .. note::
           Validation wrapper for `func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_descriptive_statistics
    ...
    def longest_strike(data: np.ndarray, threshold: float, above: bool = True) -> int:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_longest_strike`
    ...
    def sliding_longest_strike(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.longest_strike`
    ...
    def time_since_previous_threshold(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.time_since_previous_target_value`
    ...
    def time_since_previous_target_value(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.time_since_previous_threshold`
    ...
    def benford_correlation(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_benford_correlation`
    ...
    def sliding_benford_correlation(
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.benford_correlation`
    ...
    def sliding_pct_in_top_n(x: np.ndarray, windows: np.ndarray, n: int, fps: float) -> np.ndarray:
        ...
        .. note::
          To compute percentage of elements in the top 'n' frequencies in entire array, use :func:`mufasa.mixins.statistics_mixin.Statistics.pct_in_top_n()`.
    ...
    def linearity_index(x: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_linearity_index`, :func:`mufasa.data_processors.cuda.timeseries.sliding_linearity_index_cuda`
    ...
    def sliding_linearity_index(x: np.ndarray,
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.linearity_index`, :func:`mufasa.data_processors.cuda.timeseries.sliding_linearity_index_cuda`
    ...
    def entropy_of_directional_changes(x: np.ndarray, bins: int = 16) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_entropy_of_directional_changes`
    ...
    def sliding_entropy_of_directional_changes(x: np.ndarray,
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.entropy_of_directional_changes`
    ...
    def path_curvature(x: np.ndarray, agg_type: Literal['mean', 'median', 'max'] = 'mean') -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_path_curvature`
    ...
    def sliding_path_curvature(x: np.ndarray,
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.path_curvature`
    ...
    def spatial_density(x: np.ndarray,
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.sliding_spatial_density`, :func:`mufasa.data_processors.cuda.timeseries.sliding_spatial_density_cuda`
    ...
    def sliding_spatial_density(x: np.ndarray,
        ...
        .. seealso::
           :func:`mufasa.mixins.timeseries_features_mixin.TimeseriesFeatureMixin.spatial_density`, :func:`mufasa.data_processors.cuda.timeseries.sliding_spatial_density_cuda`
    ...
    def sliding_avg_kinetic_energy(x: np.ndarray, mass: np.ndarray, sample_rate: float, time_window: float) -> np.ndarray:
        ...
        :param np.ndarray x: A 2D NumPy array of shape (n, 2), where each row contains the x and y  position coordinates of the object at each time step.
        :param np.ndarray mass: A 1D NumPy array of shape (n,), representing the mass of the object at each time step. For instance, this could be derived using  :func:`~mufasa.feature_extractors.perimeter_jit.jitted_hull`.

...
from mufasa.utils.checks import check_float, check_valid_array
from mufasa.utils.data import get_mode
...
class CircularStatisticsMixin(object):
    ...
    def mean_resultant_vector_length(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_resultant_vector_length`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_mean_resultant_vector_length`
    ...
    def sliding_mean_resultant_vector_length(data: np.ndarray, fps: float, time_windows: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_resultant_vector_length`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.mean_resultant_vector_length`
    ...
    def circular_mean(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_mean`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_mean`
    ...
    def sliding_circular_mean(data: np.ndarray, time_windows: np.ndarray, fps: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_mean`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.circular_mean`
    ...
    def circular_std(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_std`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_std`
    ...
    def sliding_circular_std(
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_std`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.circular_std`
    ...
    def instantaneous_angular_velocity(data: np.ndarray, bin_size: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.instantaneous_angular_velocity`
    ...
    def degrees_to_cardinal(data: np.ndarray) -> List[str]:
        ...
        .. note::
           To convert cardinal literals to integers, map using :func:`mufasa.utils.enums.lookups.cardinality_to_integer_lookup`.
           To convert integers to cardinal literals, map using :func:`mufasa.utils.enums.lookups.integer_to_cardinality_lookup`.
    ...
    def sliding_bearing(x: np.ndarray, lag: float, fps: float) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_bearing`
    ...
    def direction_three_bps(nose_loc: np.ndarray, left_ear_loc: np.ndarray, right_ear_loc: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For two-point direction calculation, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_two_bps`.
           For GPU-accelerated implementations, see :func:`mufasa.data_processors.cuda.circular_statistics.direction_from_two_bps` and :func:`mufasa.data_processors.cuda.circular_statistics.direction_from_three_bps`.
    ...
    def three_point_direction(nose_loc: np.ndarray,
        ...
        .. seealso::
           For the underlying numba-accelerated implementation, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_three_bps`.
           For two-point direction calculation, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_two_bps`.
    ...
    def direction_two_bps(anterior_loc: np.ndarray, posterior_loc: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_three_bps`
           :func:`mufasa.data_processors.cuda.circular_statistics.direction_from_two_bps`
           :func:`mufasa.data_processors.cuda.circular_statistics.direction_from_three_bps`
    ...
    def two_point_direction(anterior_loc: np.ndarray, posterior_loc: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           For the underlying numba-accelerated implementation, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_two_bps`
           For three-point direction calculation, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.three_point_direction` or :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_three_bps`
    ...
    def rayleigh(data: np.ndarray) -> Tuple[float, float]:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_rayleigh_z`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_rayleigh_z`
    ...
    def sliding_rayleigh_z(data: np.ndarray, time_windows: np.ndarray, fps: int) -> Tuple[np.ndarray, np.ndarray]:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_rayleigh_z`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.rayleigh`
    ...
    def circular_correlation(sample_1: np.ndarray, sample_2: np.ndarray) -> float:
        ...
        .. seealso:
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_correlation`
    ...
    def sliding_circular_correlation(sample_1: np.ndarray, sample_2: np.ndarray, time_windows: np.ndarray, fps: float) -> np.ndarray:
        ...
        .. seealso:
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.circular_correlation`
    ...
    def rao_spacing(data: np.array):
        ...
        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_rao_spacing`
    ...
    def sliding_rao_spacing(data: np.ndarray, time_windows: np.ndarray, fps: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.rao_spacing`
    ...
    def kuipers_two_sample_test(sample_1: np.ndarray, sample_2: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_kuipers_two_sample_test`
    ...
    def sliding_kuipers_two_sample_test(sample_1: np.ndarray, sample_2: np.ndarray, time_windows: np.ndarray, fps: int) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.kuipers_two_sample_test`
    ...
    def sliding_hodges_ajne(data: np.ndarray, time_window: float, fps: int) -> np.ndarray:
        ...
        .. seealso::
           For computing the Hodges-Ajne statistic on a single sample, see :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.hodges_ajne`.
    ...
    def circular_range(data: np.ndarray) -> float:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_range`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_range`
    ...
    def sliding_circular_range(data: np.ndarray, time_windows: np.ndarray, fps: int ) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_range`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.circular_range`
    ...
    def circular_hotspots(data: np.ndarray, bins: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.sliding_circular_hotspots`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_hotspots`
    ...
    def sliding_circular_hotspots(data: np.ndarray, bins: np.ndarray, time_window: float, fps: float) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.data_processors.cuda.circular_statistics.circular_hotspots`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_circular_hotspots`
    ...
    def rotational_direction(data: np.ndarray, stride: int = 1) -> np.ndarray:
        ...
        .. seealso::
           See :func:`~mufasa.data_processors.cuda.circular_statistics.rotational_direction` for GPU acceleration.
    ...
    def preferred_turning_direction(x: np.ndarray) -> int:
        ...
        .. note::
           ...
           - :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_two_bps`
           - :func:`mufasa.data_processors.cuda.circular_statistics.direction_from_two_bps`
           - :func:`mufasa.data_processors.cuda.circular_statistics.direction_from_three_bps`
           - :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.direction_three_bps`

        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.rotational_direction`, :func:`~mufasa.data_processors.cuda.circular_statistics.rotational_direction`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.sliding_preferred_turning_direction`
    ...
    def sliding_preferred_turning_direction(x: np.ndarray,
        ...
        .. seealso::
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.rotational_direction`, :func:`~mufasa.data_processors.cuda.circular_statistics.rotational_direction`,
           :func:`mufasa.mixins.circular_statistics.CircularStatisticsMixin.preferred_turning_direction`

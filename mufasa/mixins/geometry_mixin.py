...
from mufasa.utils.data import (create_color_palette, create_color_palettes,
...
class GeometryMixin(object):
    ...
    .. note::
       ...
       To create visualizations with geometries overlay on videos, pass returned shapes to :func:`mufasa.plotting.geometry_plotter.GeometryPlotter`.
    ...
    def bodyparts_to_polygon(data: np.ndarray,
        ...
        .. seealso::
           If multicore method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_bodyparts_to_polygon`.
           For GPU method, see :func:`mufasa.data_processors.cuda.geometry.get_convex_hull`
    ...
    def bodyparts_to_points(data: np.ndarray,
        ...
        .. seealso::
           If having a large number of body-parts, consider using :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_bodypart_to_point`
    ...
    def bodyparts_to_circle(data: np.ndarray,
        ...
        .. note::
           For multicore method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_bodyparts_to_circle`
    ...
    def compute_pct_shape_overlap(shapes: np.ndarray, denominator: Optional[Literal["difference", "shape_1", "shape_2"]] = "difference") -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_compute_pct_shape_overlap` with parallel CPU acceleration. See
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.compute_shape_overlap` to compute boolean if shapes overlap.
    ...
    def compute_shape_overlap(shapes: Union[np.ndarray, List[List[Union[Polygon, LineString, None]]]],
        ...
        .. seealso::
           For multicore method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_compute_shape_overlap`
    ...
    def area(shape: Union[MultiPolygon, Polygon], pixels_per_mm: Optional[float]) -> float:
        ...
        .. note::
           If certain that the input data is a valid Polygon, consider using :func:`mufasa.feature_extractors.perimeter_jit.jitted_hull` or :func:`mufasa.data_processors.cuda.geometry.poly_area` for numba jit and CUDA acceleration, respectively.

        .. seealso:
           For multiprocessing, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_area`
    ...
    def shape_distance(shapes: Union[List[List[Union[LineString, Polygon, Point]]], np.ndarray],
        ...
        .. seealso:
           For multicore wrapper method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_shape_distance`
    ...
    def bodyparts_to_line(data: np.ndarray,
        ...
        .. seealso:
           For multicore method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_bodyparts_to_line`
    ...
    def difference(shapes=List[Union[LineString, Polygon, MultiPolygon]]) -> Polygon:
        ...
        .. seealso:
           For multicore method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_difference`
    ...
    def union(shapes: List[Union[LineString, Polygon, MultiPolygon]]) -> Union[MultiPolygon, Polygon, MultiLineString]:
        ...
        .. seealso:
           For multicore method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_union`
    ...
    def symmetric_difference(shapes: List[Union[LineString, Polygon, MultiPolygon]]) -> List[
        ...
        .. seealso:
           For multicore call, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_symmetric_difference`.
    ...
    def view_shapes(shapes: List[Union[LineString, Polygon, MultiPolygon, MultiLineString, Point]],
        ...
        .. seealso::
           See :func:`mufasa.mixins.geometry_mixin.GeometryMixin.geometry_video` or :func:`mufasa.plotting.geometry_plotter.GeometryPlotter` for videos.
    ...
    def geometry_video(
        ...
        .. seealso::
           * If more aesthetic videos are needed, overlaid on video, then use func:`mufasa.plotting.geometry_plotter.GeometryPlotter`
           * If single images of geometries are needed, then use :func:`mufasa.mixins.geometry_mixin.view_shapes()`
    ...
    def minimum_rotated_rectangle(shape: Union[Polygon, np.ndarray],
        ...
        .. seealso::
           * For multicore call, use :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_minimum_rotated_rectangle`
           * For axis-aligned bboxes, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.keypoints_to_axis_aligned_bounding_box`
    ...
    def length(shape: Union[LineString, MultiLineString],
        ...
        .. seealso::
            :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_bodyparts_to_line`, :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_length`
    ...
    def multiframe_bodyparts_to_polygon(self,
        ...
        .. note::
           To convert single frame animal body-part coordinates to polygon, use  single core method :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bodyparts_to_polygon`
    ...
    def multiframe_bodypart_to_point(data: np.ndarray,
        ...
        .. seealso::
           For non-parallized call, use :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bodyparts_to_points`
    ...
    def multiframe_buffer_shapes(geometries: List[Union[Polygon, LineString]],
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.buffer_shape`
    ...
    def multiframe_bodyparts_to_circle(self,
        ...
        .. seealso::
           For non-parallized call, use :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bodyparts_to_circle`
    ...
    def delaunay_triangulate_keypoints(data: np.ndarray) -> List[Polygon]:
        ...
        .. seealso::
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_delaunay_triangulate_keypoints`
    ...
    def multiframe_bodyparts_to_line(self,
        ...
        .. seealso::
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bodyparts_to_line`
    ...
    def multiframe_compute_pct_shape_overlap(self,
        ...
        .. seealso::
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.compute_pct_shape_overlap`. For Boolean rather than percent
           results (if geometries are overlapping), see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_compute_shape_overlap`
    ...
    def multiframe_compute_shape_overlap(self,
        ...
        .. note::
           This function only returns Boolean if two shapes are overlapping or not overlapping. If the amount of overlap is required, use :func:`mufasa.mixins.geometry_mixin.GeometryMixin.compute_pct_shape_overlap`
           of :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_compute_pct_shape_overlap`.

           Note that shape_1 and shape_2 entries can be NoneType. If so no overlap will be in the output for that observation.

        .. seealso:
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.compute_shape_overlap`, :func:`mufasa.mixins.geometry_mixin.GeometryMixin.compute_pct_shape_overlap`, :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_compute_pct_shape_overlap`
    ...
    def multiframe_shape_distance(self,
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.shape_distance`
    ...
    def multiframe_minimum_rotated_rectangle(self,
        ...
        .. seealso::
           For single-core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.minimum_rotated_rectangle`
    ...
    def line_split_bounding_box(intersections: np.ndarray, bounding_box: np.ndarray) -> GeometryCollection:
        ...
        .. note::
          Extended line can be found by body-parts using :func:`mufasa.mixins.geometry_mixin.GeometryMixin.extend_line_to_bounding_box_edges`.
    ...
    def multiframe_length(self,
        ...
        .. seealso::
           For single core process, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.length`
    ...
    def multiframe_union(self,
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.union`
    ...
    def multiframe_symmetric_difference(self, shapes: Iterable[Union[LineString, MultiLineString, Polygon]],
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.symmetric_difference`
    ...
    def multiframe_delaunay_triangulate_keypoints(self,
        ...
        .. seealso::
           For single core process, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.delaunay_triangulate_keypoints`
    ...
    def multiframe_difference(
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.difference`
    ...
    def multiframe_area(self,
        ...
        .. note::
           If certain that the input data are valid Polygons, consider using :func:`mufasa.feature_extractors.perimeter_jit.jitted_hull` or :func:`mufasa.data_processors.cuda.geometry.poly_area` for numba jit and CUDA acceleration, respectively.
    ...
    def multiframe_bodyparts_to_multistring_skeleton(
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bodyparts_to_multistring_skeleton`
    ...
    def get_geometry_brightness_intensity(img: Union[np.ndarray, Tuple[cv2.VideoCapture, int]],
        ...
        E.g., can be used with hardcoded thresholds or model kmeans in `mufasa.mixins.statistics_mixin.Statistics.kmeans_1d` to detect if a light source is ON or OFF state.
        ...
        .. seealso::
           For direct image brightness comparisons without geometry slicing, see :func:`mufasa.mixins.image_mixin.ImageMixin.brightness_intensity`.
           For GPU acceleration, see :func:`mufasa.data_processors.cuda.image.img_stack_brightness()`
    ...
    def geometry_histocomparison(
        ...
        .. seealso::
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multifrm_geometry_histocomparison`
    ...
    def multiframe_is_shape_covered(self,
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.is_shape_covered`
    ...
    def multifrm_geometry_histocomparison(self,
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.geometry_histocomparison`
    ...
    def contours_to_geometries(contours: List[np.ndarray],
        ...
        E.g., convert a list of contours detected with :func:`mufasa.mixins.image_mixin.ImageMixin.find_contours` to a list of Shapely geometries
        that can be used within the :func:`mufasa.mixins.geometry_mixin.GeometryMixin`.
    ...
    def bucket_img_into_grid_points(point_distance: int,
        ...
        .. seealso::
           To segment image into **hexagons**, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`.
           To segment image into **rectangles**, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_square`
    ...
    def bucket_img_into_grid_square(img_size: Iterable[int],
        ...
        .. seealso::
           To segment image into **hexagons**, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`.
           To segment image into **points**, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_points`
    ...
    def cumsum_coord_geometries(self,
        ...
        .. seealso::
           To create grid ``geometries``, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_square` or :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`.

        :param np.ndarray data: Input data array where rows represent frames and columns represent body-part x and y coordinates.
        :param Dict[Tuple[int, int], Polygon] geometries: Dictionary of polygons representing spatial regions. E.g., created by :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_square` or :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`.
    ...
    def cumsum_bool_geometries(self,
        ...
        .. seealso::
           * To create grid ``geometries``, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_square`
           * To create hexagonal grid ``geometries``, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`
           * To get Boolean counts, consider :func:`mufasa.utils.data.detect_bouts`
    ...
    def cumsum_animal_geometries_grid(self,
        ...
        .. seealso::
           To calculate the time / count of boolean events in geometries, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.cumsum_bool_geometries`.
           To calculate the cumulative time the animal has spent in each geometry using a single key-point, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.cumsum_coord_geometries`.
        ...
        :param Dict[Tuple[int, int], Polygon] grid: Dictionary of polygons representing spatial regions. E.g., created by :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_square` or :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`.
    ...
    def geometry_transition_probabilities(data: np.ndarray,
        ...
        :param Dict[Tuple[int, int], Polygon] grid: A dictionary mapping grid cell identifiers (tuple of int, int) to their corresponding polygon objects.
                                                    Each grid cell is represented by a tuple key (e.g., (row, col)) and its spatial boundaries as a `Polygon`. Can be computed with E.g., created by :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_square` or :func:`mufasa.mixins.geometry_mixin.GeometryMixin.bucket_img_into_grid_hexagon`.
    ...
    def hausdorff_distance(geometries: List[List[Union[Polygon, LineString]]]) -> np.ndarray:
        ...
        .. seealso::
           :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_hausdorff_distance`
    ...
    def multiframe_hausdorff_distance(self,
        ...
        .. seealso::
           For single core method, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.hausdorff_distance`
    ...
    def keypoints_to_axis_aligned_bounding_box(keypoints: np.ndarray) -> np.ndarray:
        ...
        .. seealso::
           * For minimum rotated bounding boxes, see :func:`mufasa.mixins.geometry_mixin.GeometryMixin.minimum_rotated_rectangle` or :func:`mufasa.mixins.geometry_mixin.GeometryMixin.multiframe_minimum_rotated_rectangle`
    ...
    def points_in_polygon(x: typed.List) -> types.List:
        ...
        .. image:: _static/img/mufasa.mixins.geometry_mixin.GeometryMixin.points_in_polygon.webp
           :width: 400
           :align: center

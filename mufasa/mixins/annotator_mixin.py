...
from mufasa.ui.tkinter_functions import Entry_Box
from mufasa.utils.checks import check_int
from mufasa.utils.enums import Formats, Labelling
from mufasa.utils.errors import FrameRangeError, InvalidInputError
from mufasa.utils.printing import SimbaTimer, stdout_success
from mufasa.utils.read_write import (find_time_stamp_from_frame_numbers,
                                    get_all_clf_names, get_fn_ext,
                                    get_video_meta_data, read_df, write_df)
from mufasa.utils.warnings import FrameRangeWarning
from mufasa.video_processors.video_processing import clip_video_in_range
...
class AnnotatorMixin(ConfigReader):
    ...
    def targeted_bouts_pane(self, parent: Frame) -> Frame:
        """Create a pane for choosing bouts start and end and a radiobutton truth table for targeted bouts annotations. Used by mufasa.labelling.targeted_annotations_bouts.TargetedAnnotatorBouts"""

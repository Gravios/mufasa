...
class TrainModelMixin(object):
    ...
    def read_all_files_in_folder(self,
        ...
        .. note::
           For improved runtime using multiprocessing and pyarrow, use :func:`~mufasa.mixins.train_model_mixin.read_all_files_in_folder_mp`
           For improved runtime using ``concurrent` library, use :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.read_all_files_in_folder_mp_futures`.
    ...
    def create_example_dt(self,
        ...
        .. note::
           `Example expected output  <https://github.com/sgoldenlab/mufasa/blob/master/misc/create_example_dt.pdf>`__.
    ...
    def create_clf_report(self,
        ...
        .. seealso::
           `Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario1.md#train-predictive-classifiers-settings>`_
    ...
    def create_x_importance_log(self,
        ...
        .. note::
           `Example expected output  <https://github.com/sgoldenlab/mufasa/blob/master/images/BtWGaNP_feature_importance_log.csv>`__.

        .. seealso::
           To plot gini / entropy based feature importance scores, see :func:`~mufasa.mixins.train_model_mixin.TrainModelMixin.create_x_importance_bar_chart`
    ...
    def create_shap_log(self,
        ...
        .. seealso::
           For multicore solution, see :func:`~mufasa.mixins.train_model_mixins.TrainModelMixin.create_shap_log_mp`
           For GPU method, see :func:`~mufasa.data_processors.cuda.create_shap_log.create_shap_log`
    ...
    def save_rf_model(self,
        ...
        .. seealso::
           To write pickle, can also use :func:`~mufasa.utils.read_write.write_pickle`
           To read pickle, see :func:`~mufasa.utils.read_write.read_pickle` or :func:`~mufasa.mixins.train_model_mixin.TrainModelMixin.read_pickle`.
    ...
    def find_highly_correlated_fields(data: np.ndarray,threshold: float, field_names: types.ListType(types.unicode_type)) -> List[str]:
        ...
        .. seealso::
           For non-numba method, see :func:`mufasa.mixins.statistics_mixin.Statistics.find_collinear_features`.
           For validation wrapper, see :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.find_collinear_features`
    ...
    def find_collinear_features(data: pd.DataFrame,
        ...
        .. seealso::
           For the underlying numba-accelerated implementation, see :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.find_highly_correlated_fields`
           For non-numba statistical methods, see :func:`mufasa.mixins.statistics_mixin.Statistics.find_collinear_features`
    ...
    def clf_predict_proba(self,
        ...
        .. seealso::
           To fit a classifier, see :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.clf_fit`
           To define a classifier, see :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.clf_define`
    ...
    def clf_fit(self,
        ...
        .. seealso::
           To define a cuml/sklearn object, see :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.clf_define`
    ...
    def _read_data_file_helper(file_path: str,
        ...
        """
        Private function called by :meth:`mufasa.train_model_functions.read_all_files_in_folder_mp`
        """
    ...
    def read_all_files_in_folder_mp(file_paths: List[str],
        ...
        .. note::
          If multiprocess fail, reverts to :meth:`mufasa.mixins.train_model_mixin.read_all_files_in_folder`

        .. seealso::
           For single process method, use :func:`~mufasa.mixins.train_model_mixin.TrainModelMixin.read_all_files_in_folder`
           For `concurrent` library, use :func:`mufasa.mixins.train_model_mixin.TrainModelMixin.read_all_files_in_folder_mp_futures`.
    ...
    def read_all_files_in_folder_mp_futures(self,
        ...
        .. note::
           A ``concurrent.Futures`` alternative to :meth:`mufasa.mixins.train_model_mixin.read_all_files_in_folder_mp` which
           has uses ``multiprocessing.ProcessPoolExecutor`` and reported unstable on Linux machines.

           If multiprocess failure, reverts to :meth:`mufasa.mixins.train_model_mixin.read_all_files_in_folder`
    ...
    def create_shap_log_mp(self,
        ...
        .. seealso::
           `Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario1.md#train-predictive-classifiers-settings>`_
            For single-core solution, see :func:`~mufasa.mixins.train_model_mixins.TrainModelMixin.create_shap_log`
            For GPU method, see :func:`~mufasa.data_processors.cuda.create_shap_log.create_shap_log`
            For multiprocassing concurrent futures method (should be more reliable on Linux distros), see :func:`~mufasa.mixins.train_model_mixin.TrainModelMixin.create_shap_log_concurrent_mp`
    ...
    def create_shap_log_concurrent_mp(self,
        ...
        .. seealso::
           `Documentation <https://github.com/sgoldenlab/mufasa/blob/master/docs/Scenario1.md#train-predictive-classifiers-settings>`_
            For single-core solution, see :func:`~mufasa.mixins.train_model_mixins.TrainModelMixin.create_shap_log`
            For GPU method, see :func:`~mufasa.data_processors.cuda.create_shap_log.create_shap_log`
            For multiprocassing imap method (reliably runs on Windows and Mac), see :func:`~mufasa.mixins.train_model_mixin.TrainModelMixin.create_shap_log_mp`
...
#     #from mufasa.mixins.train_model_mixin import TrainModelMixin
#     x_cols = list(pd.read_csv(r"C:\projects\mufasa\mufasa\tests\data\sample_data\shap_test.csv", index_col=0).columns)
